...
<div dir="rtl"><ul>
 <li>لاگ مسلیں میں کالعدم آئی پی ایس سے مسدود درخواستوں شامل کریں؟ سچا = جی ہاں [ڈیفالٹ]؛ False (جھوٹی) = نمبر.</li>
</ul></div>
...
<div dir="rtl"><ul>
 <li>انحرافات شمار کب کیا جانا چاہئے؟ False (جھوٹی) = آئی پی ایس کے ماڈیول کی طرف سے بلاک کر رہے ہیں جب. سچا = آئی پی ایس کے کسی بھی وجہ سے بلاک کر رہے ہیں جب.</li>
</ul></div>
...
<div dir="rtl"><ul>
 <li>متعین کرتا ہیشز مخصوص آئی پی ایس کو بند کر دیا جانا چاہئے یا نہیں. False (جھوٹی) = کوکیز اور ہیشز ایک سے زیادہ آئی پی ایس (پہلے سے مقررشدہ) بھر میں استعمال کیا جا سکتا. سچا = کوکیز اور ہیشز ایک سے زیادہ آئی پی ایس کے اس پار نہیں کیا جا سکتا (کوکیز / ہیشز آئی پی ایس کو بند کر دیا جاتا).</li>
...
<div dir="rtl">آخری تازہ کاری: 6 نومبر 2017 (2017.11.06).</div>
