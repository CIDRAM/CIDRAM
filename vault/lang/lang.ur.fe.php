 ...
 * @see LICENSE.txt
 *
 * This file: Urdu language data for the front-end (last modified: 2017.11.06).
 */
...
$CIDRAM['lang']['config_general_log_banned_ips'] = 'لاگ مسلیں میں کالعدم آئی پی ایس سے مسدود درخواستوں شامل کریں? True (سچے) = جی ہاں [پہلے سے طے شدہ]; False (جھوٹی) = نہیں.';
$CIDRAM['lang']['config_general_maintenance_mode'] = 'بحالی کا موڈ فعال کریں؟ True (سچے) = جی ہاں؛ False (جھوٹی) = کوئی [ڈیفالٹ]. سامنے کے اختتام کے مقابلے میں سب کچھ غیر فعال کرتا ہے. کبھی کبھی آپ کے CMS، فریم ورک، وغیرہ کو اپ ڈیٹ کرنے کے لئے مفید ہے.';
...
$CIDRAM['lang']['config_signatures_track_mode'] = 'انحرافات شمار کب کیا جانا چاہئے؟ False (جھوٹی) = آئی پی ایس کے ماڈیول کی طرف سے بلاک کر رہے ہیں جب. سچا = آئی پی ایس کے کسی بھی وجہ سے بلاک کر رہے ہیں جب.';
