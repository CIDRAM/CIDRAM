...
$CIDRAM['lang']['config_general_ban_override'] = 'کی منسوخی "forbid_on_block" کب "infraction_limit" حد سے تجاوز کر رہا ہے? زیرکر کب: التواء درخواستوں ایک خالی صفحے کو واپس (سانچے فائلوں کا استعمال نہیں کر رہے ہیں). 200 = کی جگہ لے لے نہیں ہے [پہلے سے طے شدہ]؛ کے ساتھ "403 حرام" 403 = جگہ لے لے؛ کے ساتھ "503 سروس دستیاب نہیں 503 = زیر کریں".';
...
$CIDRAM['lang']['info_some_useful_links'] = 'کچھ مفید لنکس:<ul>
            ...
            <li><a href="https://github.com/macmathan/Blocklists" dir="ltr">macmathan/Blocklists</a> – CIDRAM کے لئے اختیاری بلاسٹ لسٹ اور ماڈیولز پر مشتمل ہے جیسے خطرناک بٹس کو روکنے، ناپسندیدہ ممالک، پرانے براؤزر وغیرہ.</li>
