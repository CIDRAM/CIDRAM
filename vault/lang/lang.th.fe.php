 ...
 * @see LICENSE.txt
 *
 * This file: Thai language data for the front-end (last modified: 2018.05.01).
 */
...
$CIDRAM['lang']['config_signatures_block_legal'] = 'บล็อก CIDR เพื่อตอบสนองต่อข้อผูกมัดทางกฎหมายหรือไม่? คำสั่งนี้ไม่ควรได้ตามปกติมีผลใด ๆ เนื่องจาก CIDRAM ไม่ได้เชื่อมโยง CIDR กับ "ข้อผูกมัดทางกฎหมาย" ตามค่าเริ่มต้น แต่ยังคงมีอยู่เป็นมาตรการควบคุมเพิ่มเติมเพื่อประโยชน์ของไฟล์ลายเซ็นที่กำหนดเองหรือโมดูลที่อาจมีเหตุผลทางกฎหมาย.';
$CIDRAM['lang']['config_signatures_block_proxies'] = 'บล็อก CIDR ที่ระบุว่าเป็นของบริการพร็อกซีหรือ VPN หรือไม่? หากผู้ใช้ของคุณต้องการเข้าถึงเว็บไซต์ของคุณจากบริการพร็อกซีและ VPN, ควรตั้งค่าเป็น false. มิฉะนั้น ถ้าคุณไม่ต้องการบริการพร็อกซี่หรือ VPN, ควรตั้งค่าเป็น true เพื่อเพิ่มความปลอดภัย.';
...
$CIDRAM['lang']['state_sl_totals'] = 'ผลรวม (ลายเซ็น: <span class="txtRd">%s</span> – ส่วนลายเซ็น: <span class="txtRd">%s</span> – ไฟล์ลายเซ็น: <span class="txtRd">%s</span>).';
...
$CIDRAM['lang']['title_cache_data'] = 'CIDRAM – ข้อมูลแคช';
...
$CIDRAM['lang']['title_range'] = 'CIDRAM – ตารางช่วง';
$CIDRAM['lang']['title_sections_list'] = 'CIDRAM – รายการส่วน';
