...
$CIDRAM['lang']['click_here'] = 'klicka här';
$CIDRAM['lang']['denied'] = 'Nekat Tillgång!';
...
$CIDRAM['lang']['field_rURI'] = 'Rekonstruerad URI: ';
$CIDRAM['lang']['field_scriptversion'] = 'Script Version: ';
$CIDRAM['lang']['field_sigcount'] = 'Signaturer Räknas: ';
$CIDRAM['lang']['field_sigref'] = 'Signatur Referens: ';
$CIDRAM['lang']['field_ua'] = 'Användaragent: ';
$CIDRAM['lang']['field_whyreason'] = 'Varför Blockeras: ';
$CIDRAM['lang']['generated_by'] = 'Genererad av';
$CIDRAM['lang']['preamble'] = '-- Slut på ingressen. Lägg till dina frågor eller kommentarer efter den här raden. --';
...
$CIDRAM['lang']['recaptcha_cookie_warning'] = 'Notera: CIDRAM använder en cookie som kommer ihåg när användarna slutför CAPTCHA. Genom att fylla i CAPTCHA, ger du ditt samtycke till att en cookie ska skapas och lagras av din webbläsare.';
$CIDRAM['lang']['recaptcha_disabled'] = 'Inaktiverad.';
