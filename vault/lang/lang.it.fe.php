...
foreach (['IPv4', 'IPv6'] as $CIDRAM['IPvX']) {
    $CIDRAM['Pre'] = 'Firme ' . $CIDRAM['IPvX'] . ' predefiniti normalmente inclusi nel pacchetto principale. ';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX']] = $CIDRAM['Pre'] . 'Blocca servizi cloud indesiderate e punti finali non umani.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-Bogons'] = $CIDRAM['Pre'] . 'Blocca bogon/marziano CIDRs.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-ISPs'] = $CIDRAM['Pre'] . 'Blocca ISP pericolosi e spam incline.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-Other'] = $CIDRAM['Pre'] . 'Blocca CIDRs per i proxy, VPN e altri vari servizi indesiderati.';
    $CIDRAM['Pre'] = 'File di firme per ' . $CIDRAM['IPvX'] . ' (%s).';
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX']] = sprintf($CIDRAM['Pre'], 'servizi cloud indesiderate e punti finali non umani');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-Bogons'] = sprintf($CIDRAM['Pre'], 'bogon/marziano CIDRs');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-ISPs'] = sprintf($CIDRAM['Pre'], 'ISP pericolosi e spam incline');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-Other'] = sprintf($CIDRAM['Pre'], 'CIDRs per i proxy, VPN e altri vari servizi indesiderati');
}
...
$CIDRAM['lang']['Extended Description: module_botua.php'] = 'Blocchi gli agenti utente associati a bot indesiderati e attività nefande.';
...
$CIDRAM['lang']['Name: compat_bunnycdn.php'] = 'BunnyCDN modulo di compatibilità';
...
$CIDRAM['lang']['Name: module_badtlds.php'] = 'Modulo bloccante di cattivi TLD';
$CIDRAM['lang']['Name: module_baidublocker.php'] = 'Modulo bloccante di Baidu';
$CIDRAM['lang']['Name: module_botua.php'] = 'Modulo opzionale di agenti utente';
...
$CIDRAM['lang']['Name: module_ua.php'] = 'Modulo blocco UA vuoto';
...
$CIDRAM['lang']['config_general_ban_override'] = 'Sostituire "forbid_on_block" quando "infraction_limit" è superato? Quando si sostituisce: Richieste bloccate restituire una pagina vuota (file di modello non vengono utilizzati). 200 = Non sostituire [Predefinito]. Altri valori sono uguali ai valori disponibili per "forbid_on_block".';
...
$CIDRAM['lang']['field_Request_Method'] = 'Metodo di richiesta';
...
$CIDRAM['lang']['label_aux_logic_all'] = 'Per innescare la regola, devono essere soddisfatte tutte le condizioni.';
$CIDRAM['lang']['label_aux_logic_any'] = 'Qualsiasi condizione "uguale" (=) può innescare la regola, purché siano soddisfatte anche tutte le condizioni "non uguali" (≠).';
...
$CIDRAM['lang']['label_check_aux'] = 'Prova anche contro le regole ausiliarie.';
$CIDRAM['lang']['label_check_modules'] = 'Prova anche contro i moduli.';
$CIDRAM['lang']['label_cidram'] = 'Versione CIDRAM utilizzata:';
$CIDRAM['lang']['label_clientinfo'] = 'Informazioni sul cliente:';
...
$CIDRAM['lang']['label_expected'] = 'Previsto';
...
$CIDRAM['lang']['label_fmgr_other_sig'] = 'Altre regole, file di firma, ecc';
$CIDRAM['lang']['label_fmgr_safety'] = 'Meccanismi di sicurezza';
...
$CIDRAM['lang']['label_unignore'] = 'Non ignorarlo';
$CIDRAM['lang']['label_unstable'] = 'Più recente instabile:';
$CIDRAM['lang']['label_used_with'] = 'Usato con: ';
...
$CIDRAM['lang']['response_2fa_invalid'] = 'Codice 2FA errato inserito. Autenticazione fallita.';
$CIDRAM['lang']['response_2fa_valid'] = 'Autenticato con successo.';
...
$CIDRAM['lang']['security_warning'] = 'Si è verificato un problema imprevisto durante l\'elaborazione della richiesta. Per favore riprova. Se i problemi persistono, ottenere aiuto dal supporto.';
...
$CIDRAM['lang']['tip_ip_test_switches'] = '(Quando non è selezionato, solo i file delle firme verranno testati).';
...
$CIDRAM['lang']['tip_pie_html'] = 'Fare clic sul nome del componente per ulteriori dettagli.';
...
$CIDRAM['lang']['title_login'] = 'Accedi';
...
$CIDRAM['lang']['info_some_useful_links'] = 'Alcuni link utili:<ul>
      ...
      <li><a href="https://bitbucket.org/macmathan/blocklists">macmathan/blocklists</a> – Contiene gli elenchi dei blocchi e moduli opzionali per CIDRAM come per bloccare di bot pericolosi, paesi indesiderati, browser obsoleti, ecc.</li>
      ...
      <li><a href="https://bgp.he.net/">Hurricane Electric BGP Toolkit</a> – Ottenere CIDRs da ASNs, determinare le relazioni di ASNs, scopri ASNs basata su nomi di rete, ecc.</li>
...
$CIDRAM['lang']['msg_template_2fa'] = '<center><p>Salve, %1$s.<br />
<br />
Il vostro codice di autenticazione a due fattori per l\'accesso al front-end di CIDRAM:</p>
<h1>%2$s</h1>
<p>Questo codice scade tra 10 minuti.</p></center>';
$CIDRAM['lang']['msg_subject_2fa'] = 'Autenticazione a due fattori';
