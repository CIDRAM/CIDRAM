...
$CIDRAM['reCAPTCHA']['GenerateTemplateData'] = function ($SiteKey, $API, $CookieWarn = false, $ApiMessage = false) {
...
$CIDRAM['reCAPTCHA']['GenerateContainer'] = function ($CookieWarn = false, $ApiMessage = false) use (&$CIDRAM) {
