 ...
 * @see LICENSE.txt
 *
 * This file: The IP testing page (last modified: 2026.08.16).
 */
            ...
            foreach ($this->Profiles as $Profile) {
                ...
                if (isset($this->ProfileSources[$Profile])) {
                    if ($this->ProfileSources[$Profile] === 'Aux') {
                        ...
                        $this->CIDRAM['ThisIP']['YesNo'] .= ' <span class="bckpicon ' . $AuxClassColour . ' toolTip auxiliary" title="' . $GenByAuxRule . '"></span>';
                    }
                }
            }
        }
