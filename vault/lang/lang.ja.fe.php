 ...
 * @see LICENSE.txt
 *
 * This file: Japanese language data for the front-end (last modified: 2016.11.28).
 */
...
$CIDRAM['lang']['info_some_useful_links'] = '役に立つリンク：<ul>
            ...
            <li><a href="https://macmathan.info/zbblock-range-blocks">MacMathan.info Range Blocks</a> – 不要な国があなたのウェブサイトにアクセスするのをブロックのために、CIDRAMに追加できるオプションの範囲ブロックが含まれています。</li>
            ...
            <li><a href="http://www.ipdeny.com/ipblocks/">IPdeny IP country blocks</a> – 国全体の署名を生成するための素晴らしい、正確なサービス。</li>
