 ...
 * @see LICENSE.txt
 *
 * This file: Russian language data for the front-end (last modified: 2018.08.12).
 */
...
$CIDRAM['lang']['config_PHPMailer'] = 'Эти директивы конфигурации могут потребоваться для функциональных возможностей, связанных с отправкой электронной почты. Дополнительную информацию и рекомендуемые значения см. в документации.';
