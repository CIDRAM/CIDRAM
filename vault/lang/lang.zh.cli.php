 ...
 * @see LICENSE.txt
 *
 * This file: Chinese (simplified) language data for CLI (last modified: 2018.01.20).
 */
...
$CIDRAM['lang']['CLI_H'] = "
 ...
 用法：
 php.exe /cidram/loader.php -键 （输入）
...
$CIDRAM['lang']['CLI_VL_Origin'] = '线%s：原产标签不包含有效的ISO 3166-1 二位字母代码！';
