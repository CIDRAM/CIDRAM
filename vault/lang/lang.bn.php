 ...
 * @see LICENSE.txt
 *
 * This file: Bangla language data (last modified: 2017.09.23).
 */
...
$CIDRAM['lang']['ReasonMessage_Bogon'] = 'এই পৃষ্ঠায় আপনার অ্যাক্সেসটি অস্বীকার করা হয়েছিল কারণ আপনার IP ঠিকানা একটি বগন ঠিকানা হিসাবে স্বীকৃত, এবং ওয়েবসাইটের মালিক bogon IP অ্যাড্রেস এই ওয়েবসাইটে সংযোগ করতে অনুমতি দেয় না।';
...
$CIDRAM['lang']['ReasonMessage_Proxy'] = 'এই পৃষ্ঠায় আপনার অ্যাক্সেসটি অস্বীকার করা হয়েছিল কারণ আপনার IP ঠিকানাটি প্রক্সি পরিষেবার অন্তর্গত হিসাবে স্বীকৃত, এবং প্রক্সি পরিষেবা এই ওয়েবসাইট থেকে সংযোগ করার অনুমতি নেই।';
