 ...
 * @see LICENSE.txt
 *
 * This file: Urdu language data for the front-end (last modified: 2018.05.01).
 */
...
$CIDRAM['lang']['config_signatures_track_mode'] = 'خلاف ورزی شمار کب کیا جانا چاہئے؟ False (جھوٹی) = IP ایس کے ماڈیول کی طرف سے بلاک کر رہے ہیں جب. سچا = IP ایس کے کسی بھی وجہ سے بلاک کر رہے ہیں جب.';
