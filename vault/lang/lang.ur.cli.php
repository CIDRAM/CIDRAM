 ...
 * @see LICENSE.txt
 *
 * This file: Urdu language data for CLI (last modified: 2017.04.04).
 */
...
$CIDRAM['lang']['CLI_V_Finished'] = 'دستخط جوازدہندہ (٪ ے) ختم ہو گیا ہے. انتباہ یا غلطیوں کو کوئی ظاہر ہوا ہے تو، آپ کے دستخط کی فائل * شاید ہے * ٹھیک. :-)';
