 ...
 * @see LICENSE.txt
 *
 * This file: Thai language data for the front-end (last modified: 2018.07.04).
 */
...
$CIDRAM['lang']['Extended Description: module_ua.php'] = 'บล็อกตัวแทนผู้ใช้ที่เกี่ยวข้องกับบอทและกิจกรรมที่ไม่เป็นที่ต้องการ.';
...
$CIDRAM['lang']['Name: module_ua.php'] = 'โมดูลตัวแทนผู้ใช้';
...
$CIDRAM['lang']['config_legal_pseudonymise_ip_addresses'] = 'Pseudonymise IP addresses เมื่อเขียนล็อกไฟล์หรือไม่? True = ทำ; False = ไม่ทำ [ค่าเริ่มต้น].';
