...
- Submit reviews about CIDRAM to various software review sites where it's listed (for example, [SourceForge](https://sourceforge.net/projects/cidram/reviews?source=navbar), [HotScripts](http://www.hotscripts.com/listing/cidram/), [WordPress](https://wordpress.org/plugins/cidram/)), write blog posts, use word of mouth, mention it on Facebook, Twitter, etc.
