...
<div dir="rtl">[يتم تسجيل CIDRAM مع Packagist](https://packagist.org/packages/maikuolan/cidram)، و بالتالي، إذا كنت على دراية به، يمكنك استخدامه لتثبيت CIDRAM (ستظل بحاجة إلى إعداده على الرغم من ذلك؛ نرى "تثبيت يدويا" الخطوتين ٢ و ٥).<br /><br /></div>

`composer require maikuolan/cidram`

#### <div dir="rtl">٢.٢ تثبيت ل ووردبريس</div>

<div dir="rtl">إذا كنت ترغب في استخدام CIDRAM مع ووردبريس، يمكنك تجاهل جميع التعليمات أعلاه.<br /><br /></div>

[يتوفر CIDRAM من قاعدة بيانات الإضافات وووردبريس](https://wordpress.org/plugins/cidram/). يمكنك تثبيته بنفس الطريقة مثل أي مكون إضافي. كما هو الحال مع أساليب التثبيت الأخرى، يمكنك تخصيص التثبيت الخاص بك عن طريق تعديل محتويات الملف `config.ini`، أو باستخدام صفحة تهيئة front-end.
