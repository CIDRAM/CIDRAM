...
function acc(e,d,i,t){var o=function(e){w('stateMsg',e)},a=function(){w('stateMsg','{Loading}')};window.username=document.getElementById(e).value,window.password=document.getElementById(d).value,window.do=document.getElementById(t).value,'delete-account'==window.do&&$('POST','',['cidram-form-target','username','password','do'],a,function(e){w('stateMsg',e),hideid(i)},o),'update-password'==window.do&&$('POST','',['cidram-form-target','username','password','do'],a,o,o)}
