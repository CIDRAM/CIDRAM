 ...
 * @see LICENSE.txt
 *
 * This file: The IP testing page (last modified: 2026.08.17).
 */
            ...
            if (
                ...
                foreach ($this->CIDRAM['ThisIP']['Matches'][1] as $this->CIDRAM['ThisIP']['ThisMatch']) {
                    $this->CIDRAM['ThisIP']['YesNo'] = \str_replace(
                        ...
                        \sprintf('<ruby style="ruby-position:under"><span class="flag %1$s"><span></span></span><rp>[</rp><rt class="flagruby" style="position:relative;bottom:-10px">%1$s</rt><rp>]</rp></ruby>', $this->CIDRAM['ThisIP']['ThisMatch']),
            ...
            foreach ($this->Profiles as $Profile) {
                ...
                if (isset($this->ProfileSources[$Profile])) {
                    ...
                    if ($this->ProfileSources[$Profile] === 'Aux') {
                        static $GenByAuxRule = $this->L10N->getString('label.This profile was generated by an auxiliary rule');
                        $this->CIDRAM['ThisIP']['YesNo'] .= ' <span class="fmicon ' . $AuxClassColour . ' toolTip auxiliary" title="' . $GenByAuxRule . '"></span>';
                    } elseif ($this->ProfileSources[$Profile] === 'Sig') {
                        static $GenBySigFile = $this->L10N->getString('label.This profile was generated by a signature file');
                        $this->CIDRAM['ThisIP']['YesNo'] .= ' <span class="fmicon ' . $AuxClassColour . ' toolTip database" title="' . $GenBySigFile . '"></span>';
                    } elseif (($Try = $this->L10N->getString('Name.' . $this->ProfileSources[$Profile])) !== '') {
                        static $GenByOther = $this->L10N->getString('label.Generated by %s');
                        static $QuoteEntity = $this->L10N->getString('label.Quote entity');
                        $this->CIDRAM['ThisIP']['YesNo'] .= ' <span class="fmicon ' . $AuxClassColour . ' toolTip module" title="' . \sprintf($GenByOther, \sprintf($QuoteEntity, $this->ProfileSources[$Profile])) . '"></span>';
                    }
                }
            }
        }
