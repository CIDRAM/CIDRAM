 ...
 * @see LICENSE.txt
 *
 * This file: Extended rules for Soft Layer CIDRs (last modified: 2019.05.10).
 */
...
$CIDRAM['RunParamResCache']['rules_softlayer.php'] = function (array $Factors = [], int $FactorIndex = 0, int $LN = 0, string $Tag = '') use (&$CIDRAM) {
