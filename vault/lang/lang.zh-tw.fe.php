...
$CIDRAM['lang']['Extended Description: module_botua.php'] = '阻止不需要的機器人和惡意活動相關聯的用戶代理。';
...
$CIDRAM['lang']['Name: module_botua.php'] = '可選的用戶代理模塊';
...
$CIDRAM['lang']['Name: module_ua.php'] = '空UA阻塞模塊';
...
$CIDRAM['lang']['config_general_social_media_verification'] = '嘗試驗證社交媒體請求？​社交媒體驗證可以防止虛假社交媒體請求（此類請求將被阻止）。​True（真）=啟用社交媒體驗證【標準】；​False（假）=禁用社交媒體驗證。';
...
$CIDRAM['lang']['config_legal_pseudonymise_ip_addresses'] = '編寫日誌文件時使用假名的IP地址嗎？​True（真）=使用假名【標準】；False（假）=不使用假名。';
$CIDRAM['lang']['config_rate_limiting_allowance_period'] = '監視使用情況的小時數。​標準=0。';
$CIDRAM['lang']['config_rate_limiting_max_bandwidth'] = '在為將來的請求啟用速率限制之前的最大允許帶寬量。​值為0將禁用此類速率限制。​標準=0KB。';
$CIDRAM['lang']['config_rate_limiting_max_requests'] = '在為將來的請求啟用速率限制之前允許的最大請求數。​值為0將禁用此類速率限制。​標準=0。';
$CIDRAM['lang']['config_rate_limiting_precision_ipv4'] = '監視IPv4使用時的精度。​值鏡像CIDR塊大小。​設置為32以獲得最佳精度。​標準=32。';
$CIDRAM['lang']['config_rate_limiting_precision_ipv6'] = '監視IPv6使用時的精度。​值鏡像CIDR塊大小。​設置為128以獲得最佳精度。​標準=128。';
...
$CIDRAM['lang']['config_signatures_block_malware'] = '阻止與惡意軟件相關的IP？​這包括C＆C服務器，受感染的機器，涉及惡意軟件分發的機器，等等。';
...
$CIDRAM['lang']['field_cidr'] = '以CIDR的形式生成輸出';
...
$CIDRAM['lang']['field_create_new_account'] = '創建新帳戶';
$CIDRAM['lang']['field_deactivate'] = '停用';
$CIDRAM['lang']['field_delete'] = '刪除';
$CIDRAM['lang']['field_delete_account'] = '刪除帳戶';
...
$CIDRAM['lang']['field_netmask'] = '以子網掩碼的形式生成輸出';
...
$CIDRAM['lang']['field_reasonmessage'] = '為什麼被阻止（詳細）';
...
$CIDRAM['lang']['field_ualc'] = '用戶代理（小寫）';
...
$CIDRAM['lang']['label_aux_actByp'] = '繞行';
$CIDRAM['lang']['label_aux_actGrl'] = '灰名單';
$CIDRAM['lang']['label_aux_actWhl'] = '白名單';
$CIDRAM['lang']['label_aux_create_new_rule'] = '創建新規則';
$CIDRAM['lang']['label_aux_logic_all'] = '為了觸發規則，必須滿足所有條件。';
$CIDRAM['lang']['label_aux_logic_any'] = '只要滿足所有『不等於』（≠）條件，任何『等於』（=）條件都可以觸發規則。';
$CIDRAM['lang']['label_aux_menu_action'] = '如果滿足以下條件，%s該請求。';
$CIDRAM['lang']['label_aux_menu_method'] = '使用%s來測試條件。';
$CIDRAM['lang']['label_aux_mtdReg'] = '正則表達式';
$CIDRAM['lang']['label_aux_mtdStr'] = '直接字符串比較';
$CIDRAM['lang']['label_aux_mtdWin'] = 'Windows風格的通配符';
$CIDRAM['lang']['label_aux_name'] = '新規則的名稱：';
$CIDRAM['lang']['label_aux_reason'] = '顯示給用戶的阻止原因：';
...
$CIDRAM['lang']['label_check_aux'] = '也用輔助規則進行測試。';
...
$CIDRAM['lang']['label_fmgr_other_sig'] = '其他規則，簽名文件，等等';
$CIDRAM['lang']['label_fmgr_safety'] = '安全機制';
...
$CIDRAM['lang']['label_show_by_origin'] = '按來源顯示';
...
$CIDRAM['lang']['label_unignore'] = '不要忽略這個';
...
$CIDRAM['lang']['link_accounts'] = '帳戶';
$CIDRAM['lang']['link_aux'] = '輔助規則';
...
$CIDRAM['lang']['link_range'] = '範圍表';
$CIDRAM['lang']['link_sections_list'] = '章節列表';
$CIDRAM['lang']['link_statistics'] = '統計';
$CIDRAM['lang']['link_textmode'] = '文字格式： <a href="%1$sfalse%2$s">簡單</a> – <a href="%1$strue%2$s">漂亮</a> – <a href="%1$stally%2$s">理貨</a>';
...
$CIDRAM['lang']['response_accounts_already_exists'] = '一個帳戶與那個用戶名已經存在！';
...
$CIDRAM['lang']['response_aux_none'] = '目前沒有任何輔助規則。';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = '新輔助規則『%s』創建成功。';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = '輔助規則『%s』刪除成功。';
...
$CIDRAM['lang']['response_sanity_1'] = '文件包含意外的內容！​文件拒絕！';
...
$CIDRAM['lang']['state_email_sent'] = '電子郵件已成功發送至『%s』。';
$CIDRAM['lang']['state_failed_missing'] = '任務失敗，因為必要的組件不可用。';
$CIDRAM['lang']['state_ignored'] = '忽略了';
$CIDRAM['lang']['state_loading'] = '載入中...';
$CIDRAM['lang']['state_loadtime'] = '頁面請求在<span class="txtRd">%s</span>秒內完成。';
$CIDRAM['lang']['state_logged_in'] = '已登錄。';
$CIDRAM['lang']['state_logged_in_2fa_pending'] = '已登錄，2FA待定。';
...
$CIDRAM['lang']['switch-tracking-aux-set-false'] = '不要檢查輔助規則';
$CIDRAM['lang']['switch-tracking-aux-set-true'] = '檢查輔助規則';
...
$CIDRAM['lang']['tip_accounts'] = '你好，​{username}。​<br />帳戶頁面允許您控制誰可以訪問CIDRAM前端。';
$CIDRAM['lang']['tip_aux'] = '你好，​{username}。<br />您可以使用此頁面為CIDRAM創建，刪除，和修改輔助規則。';
$CIDRAM['lang']['tip_cache_data'] = '你好，​{username}。<br />在這裡您可以查看緩存的內容。';
$CIDRAM['lang']['tip_cidr_calc'] = '你好，​{username}。​<br />CIDR計算器允許您計算IP地址屬於哪個CIDR。';
$CIDRAM['lang']['tip_condition_placeholder'] = '指定一個值，或留空以忽略。';
...
$CIDRAM['lang']['tip_ip_test_switches'] = '（如果未選中的，只有簽名文件將被測試）。';
...
$CIDRAM['lang']['tip_pie_html'] = '單擊組件名稱以獲取更多詳細信息。';
$CIDRAM['lang']['tip_range'] = '你好，​{username}。<br />本頁面顯示了有關當前活性簽名文件覆蓋的IP範圍的一些基本統計信息。';
$CIDRAM['lang']['tip_sections_list'] = '你好，​{username}。<br />此頁面列出當前活動簽名文件中存在哪些章節。';
...
$CIDRAM['lang']['info_some_useful_links'] = '一些有用的链接：<ul>
      ...
      <li><a href="https://bitbucket.org/macmathan/blocklists">macmathan/blocklists</a> – 包含用於CIDRAM的可選阻止列表和模塊，用於（例如）阻止危險機器人，不需要的國家，過時的瀏覽器等等目的。</li>
      ...
      <li><a href="https://bgp.he.net/">Hurricane Electric BGP Toolkit</a> – 從ASN獲取CIDR，​確定ASN關係，​基於網絡名稱發現ASN，​等等。</li>
