...
$this->CIDRAM['ModuleResCache'][$Module] = function () {
    ...
    if (isset($this->CIDRAM['ExtrasHonoured']['ruri']) && $this->BlockInfo['rURI'] !== '') {
        ...
        if (
            $this->trigger(\preg_match('~(?:^|[/?])Telerik\.Web\.UI\.WebResource\.axd(?:$|[/?])~i', $LCNrURI), $Exploit = 'CVE-2019-18935', '', $UnmarkCaptcha) || // 2024.10.30 mod 2025.08.07
            $this->trigger(\preg_match('~(?:^|[/?])\$\$\$call\$\$\$/wizard(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2025-48757', '', $UnmarkCaptcha) || // 2027.06.07
            $this->trigger(\preg_match('~(?:^|[/?])_ignition/execute-solution(?:$|[/?])~i', $LCNrURI), $Exploit = 'CVE-2021-3129', '', $UnmarkCaptcha) || // 2026.03.20
