 ...
 * @see LICENSE.txt
 *
 * This file: Bangla language data for the front-end (last modified: 2018.07.04).
 */
...
$CIDRAM['lang']['Extended Description: module_ua.php'] = 'অবাঞ্ছিত বট এবং নৃশংস কার্যকলাপের সাথে যুক্ত ব্যবহারকারী এজেন্টগুলিকে ব্লক করে।';
...
$CIDRAM['lang']['Name: module_ua.php'] = 'ঐচ্ছিক ব্যবহারকারী এজেন্ট মডিউল';
