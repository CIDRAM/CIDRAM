 ...
 * @see LICENSE.txt
 *
 * This file: Hindi language data for the front-end (last modified: 2019.01.07).
 */
...
$CIDRAM['lang']['config_legal_pseudonymise_ip_addresses'] = 'लॉग फाइल लिखते समय pseudonymize IP पते? True(सच्चे) = हाँ [डिफ़ॉल्ट]; False(झूठी) = नहीं।';
$CIDRAM['lang']['config_rate_limiting_allowance_period'] = 'उपयोग को ट्रैक करने के लिए घंटों की संख्या। डिफ़ॉल्ट = "0"।';
$CIDRAM['lang']['config_rate_limiting_max_bandwidth'] = 'भावी अनुरोधों को सीमित करने से पहले भत्ता अवधि के भीतर अधिकतम बैंडविड्थ की अनुमति दी गई है। 0 का मान इस प्रकार की दर सीमित करता है। डिफ़ॉल्ट = "0KB"।';
$CIDRAM['lang']['config_rate_limiting_max_requests'] = 'भावी अनुरोधों को सीमित करने से पहले भत्ता अवधि के भीतर अनुरोधों की अधिकतम संख्या। 0 का मान इस प्रकार की दर सीमित करता है। डिफ़ॉल्ट = "0"।';
$CIDRAM['lang']['config_rate_limiting_precision_ipv4'] = 'IPv4 उपयोग को ट्रैक करने के लिए उपयोग करने की सटीकता। मूल्य दर्पण CIDR ब्लॉक आकार। सर्वोत्तम परिशुद्धता के लिए 32 पर सेट करें। डिफ़ॉल्ट = "32"।';
$CIDRAM['lang']['config_rate_limiting_precision_ipv6'] = 'IPv6 उपयोग को ट्रैक करने के लिए उपयोग करने की सटीकता। मूल्य दर्पण CIDR ब्लॉक आकार। सर्वोत्तम परिशुद्धता के लिए 128 पर सेट करें। डिफ़ॉल्ट = "128"।';
...
$CIDRAM['lang']['field_delete'] = 'हटाएं';
...
$CIDRAM['lang']['field_reasonmessage'] = 'क्यों अवरुद्ध (विस्तृत)';
...
$CIDRAM['lang']['field_ualc'] = 'उपभोक्ता अभिकर्ता (लोअर केस)';
...
$CIDRAM['lang']['label_aux_logic_any'] = 'कोई भी "बराबर" (=) स्थितियां नियम को ट्रिगर कर सकती हैं, जब तक कि सभी "बराबर नहीं" (≠) स्थितियों को भी पूरा किया जाता है।';
$CIDRAM['lang']['label_aux_menu_action'] = 'यदि शर्तों को पूरा किया जाता है, तो अनुरोध %s करें।';
$CIDRAM['lang']['label_aux_menu_method'] = 'शर्तों का परीक्षण करने के लिए %s का प्रयोग करें।';
$CIDRAM['lang']['label_aux_mtdReg'] = 'नियमित अभिव्यक्ति';
$CIDRAM['lang']['label_aux_mtdStr'] = 'प्रत्यक्ष स्ट्रिंग तुलना';
$CIDRAM['lang']['label_aux_mtdWin'] = 'विंडोज-शैली वाइल्डकार्ड';
$CIDRAM['lang']['label_aux_name'] = 'नए नियम के लिए एक नाम:';
$CIDRAM['lang']['label_aux_reason'] = 'अवरुद्ध होने पर उपयोगकर्ता को दिया गया कारण:';
...
$CIDRAM['lang']['label_check_aux'] = 'सहायक नियमों के खिलाफ भी परीक्षण करें।';
$CIDRAM['lang']['label_check_modules'] = 'भी मॉड्यूल के खिलाफ भी परीक्षण करें।';
...
$CIDRAM['lang']['label_fmgr_other_sig'] = 'अन्य नियम, हस्ताक्षर फाइलें, आदि';
$CIDRAM['lang']['label_fmgr_safety'] = 'सुरक्षा तंत्र';
...
$CIDRAM['lang']['label_unignore'] = 'अनदेखा न करें';
...
$CIDRAM['lang']['link_aux'] = 'सहायक नियम';
...
$CIDRAM['lang']['response_aux_none'] = 'वर्तमान में कोई सहायक नियम नहीं हैं।';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = 'नया सहायक नियम, "%s", सफलतापूर्वक बनाया गया।';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = 'सहायक नियम, "%s", सफलतापूर्वक हटा दिया गया।';
...
$CIDRAM['lang']['security_warning'] = 'आपके अनुरोध को संसाधित करते समय एक अनपेक्षित समस्या आई। कृपया पुन: प्रयास करें। यदि समस्या बनी रहती है, तो समर्थन से संपर्क करें।';
...
$CIDRAM['lang']['tip_aux'] = 'हैलो, {username}।<br />आप इस पृष्ठ का उपयोग CIDRAM के लिए सहायक नियम बनाने, हटाने और संशोधित करने के लिए कर सकते हैं।';
...
$CIDRAM['lang']['tip_condition_placeholder'] = 'एक मान निर्दिष्ट करें, या उपेक्षा करने के लिए खाली छोड़ दें।';
...
$CIDRAM['lang']['tip_ip_test_switches'] = '(चयनित न होने पर, केवल हस्ताक्षर फ़ाइलों को इसके खिलाफ परीक्षण किया जाएगा)।';
...
$CIDRAM['lang']['tip_pie_html'] = 'अधिक विवरण के लिए घटक नाम पर क्लिक करें।';
...
$CIDRAM['lang']['title_login'] = 'लॉग इन करें';
...
$CIDRAM['lang']['info_some_useful_links'] = 'कुछ उपयोगी लिंक:<ul>
      ...
      <li><a href="https://bgp.he.net/">Hurricane Electric BGP टूलकिट</a> – ASN से CIDR प्राप्त करें, ASN संबंधों को निर्धारित करें, नेटवर्क नामों पर आधारित ASN की खोज करें, आदि।</li>
