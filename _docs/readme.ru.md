...
"default_dns"
- Стандарт сервер DNS использовать для имени хоста поиска. Стандарт = 8.8.8.8 (Google DNS). ВНИМАНИЕ: Изменяйте это значение только в том случае, если Вы уверены в своих действиях!
...
Последнее обновление: 12 Январь 2016 (2017.01.12).
