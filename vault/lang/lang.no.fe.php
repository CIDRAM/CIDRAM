...
foreach (['IPv4', 'IPv6'] as $CIDRAM['IPvX']) {
    $CIDRAM['Pre'] = 'Standard ' . $CIDRAM['IPvX'] . '-signaturer som normalt følger med hovedpakken. ';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX']] = $CIDRAM['Pre'] . 'Blokkerer uønskede sky-tjenester og ikke-menneskelige endepunkter.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-Bogons'] = $CIDRAM['Pre'] . 'Blokkerer bogon/martian CIDRer.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-ISPs'] = $CIDRAM['Pre'] . 'Blokkerer farlige og spam-fylte ISPer.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-Other'] = $CIDRAM['Pre'] . 'Blokkerer CIDRer for proxyer, VPN og andre uønskede tjenester.';
    $CIDRAM['Pre'] = $CIDRAM['IPvX'] . '-signaturfil (%s).';
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX']] = sprintf($CIDRAM['Pre'], 'uønskede sky-tjenester og ikke-menneskelige endepunkter');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-Bogons'] = sprintf($CIDRAM['Pre'], 'bogon/martian CIDRer');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-ISPs'] = sprintf($CIDRAM['Pre'], 'farlige og spam-fylte ISPer');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-Other'] = sprintf($CIDRAM['Pre'], 'CIDRer for proxyer, VPN og andre uønskede tjenester');
}
...
$CIDRAM['lang']['Extended Description: module_botua.php'] = 'Blokkerer brukeragenter assosiert med uønskede bots og ufarlig aktivitet.';
$CIDRAM['lang']['Extended Description: module_cookies.php'] = 'Gir noen begrensede beskyttelser mot farlige informasjonskapsler.';
...
$CIDRAM['lang']['Name: module_baidublocker.php'] = 'Baidu blokkeringsmodul';
$CIDRAM['lang']['Name: module_botua.php'] = 'Valgfri brukeragentmodul';
$CIDRAM['lang']['Name: module_cookies.php'] = 'Valgfrie informasjonskapselskannermodul';
$CIDRAM['lang']['Name: module_extras.php'] = 'Valgfrie sikkerhetstilleggsmodul';
$CIDRAM['lang']['Name: module_sfs.php'] = 'Stop Forum Spam modul';
$CIDRAM['lang']['Name: module_ua.php'] = 'Tom UA-blokkeringsmodul';
...
$CIDRAM['lang']['config_general_empty_fields'] = 'Hvordan skal CIDRAM håndtere tomme felter når du logger og viser blokkhendelseinformasjon? "include" = Inkluder tomme felt. "omit" = Utelater tomme felt [standardverdi].';
$CIDRAM['lang']['config_general_forbid_on_block'] = 'Hvilken HTTP-statusmelding skal CIDRAM sende når blokkerer forespørsler? (Se dokumentasjonen for mer informasjon).';
...
$CIDRAM['lang']['config_general_social_media_verification'] = 'Forsøk å verifisere sosial media forespørsler? Sosial media verifisering gir beskyttelse mot falske sosiale medier forespørsler (slike forespørsler vil bli blokkert). True = Aktiver sosial media verifisering [Standardverdi]; False = Deaktiver sosial media verifisering.';
...
$CIDRAM['lang']['field_include'] = 'Inkluder tomme felt';
...
$CIDRAM['lang']['field_omit'] = 'Utelater tomme felt';
...
$CIDRAM['lang']['label_aux_logic_any'] = 'Eventuelle "likeverdige" (=) betingelse kan utløse regelen, så lenge alle "ikke likeverdige" (≠) betingelser også er oppfylt.';
...
$CIDRAM['lang']['label_unignore'] = 'Ikke ignorere dette';
$CIDRAM['lang']['label_unstable'] = 'Siste ustabil:';
$CIDRAM['lang']['label_used_with'] = 'Brukes med: ';
...
$CIDRAM['lang']['link_range'] = 'Signatur Tabeller';
...
$CIDRAM['lang']['response_2fa_invalid'] = 'Feil 2FA-kode angitt. Autentisering mislyktes.';
$CIDRAM['lang']['response_2fa_valid'] = 'Autentisering lyktes.';
...
$CIDRAM['lang']['security_warning'] = 'Et uventet problem oppstod under behandlingen av forespørselen din. Vær så snill, prøv på nytt. Hvis problemer oppstår, kontakt brukerstøtte.';
...
$CIDRAM['lang']['title_login'] = 'Innloggingssiden';
...
$CIDRAM['lang']['msg_subject_2fa'] = '2FA (2-Faktorautentisering)';
