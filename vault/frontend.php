 ...
 * @see LICENSE.txt
 *
 * This file: Front-end handler (last modified: 2022.05.12).
 */
...
elseif ($CIDRAM['QueryVars']['cidram-page'] === 'updates' && ($CIDRAM['FE']['Permissions'] === 1 || ($CIDRAM['FE']['Permissions'] === 3 && $CIDRAM['FE']['CronMode'] !== ''))) {
    ...
    $CIDRAM['FetchRemotesData']();

    /** Fetch components lists. */
    $CIDRAM['FetchComponentsLists']($CIDRAM['Components']['Meta']);
    ...
    $CIDRAM['CheckVersions']($CIDRAM['Components']['RemoteMeta'], $CIDRAM['Components']['Available Versions']);
...
elseif ($CIDRAM['QueryVars']['cidram-page'] === 'file-manager' && $CIDRAM['FE']['Permissions'] === 1) {
    ...
    if (!$CIDRAM['DoughnutFile']) {
        ...
        /** Fetch components lists. */
        $CIDRAM['FetchComponentsLists']($CIDRAM['Components']['Components']);
...
elseif ($CIDRAM['QueryVars']['cidram-page'] === 'sections' && $CIDRAM['FE']['Permissions'] === 1) {
    if (!$CIDRAM['FE']['ASYNC']) {
        ...
        $CIDRAM['FE']['Data'] = (
            (!strlen($CIDRAM['Config']['signatures']['ipv4']) && !strlen($CIDRAM['Config']['signatures']['ipv6']))
