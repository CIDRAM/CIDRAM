 ...
 * @see LICENSE.txt
 *
 * This file: The intersector page (last modified: 2026.09.05).
 */

namespace CIDRAM\CIDRAM;

if (!isset($this->CIDRAM['QueryVars']['cidram-page']) || $this->CIDRAM['QueryVars']['cidram-page'] !== 'intersector' || empty($this->FE['PermissionsMap']['Range tools'])) {
    die;
}
