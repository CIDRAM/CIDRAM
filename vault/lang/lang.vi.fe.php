 ...
 * @see LICENSE.txt
 *
 * This file: Vietnamese language data for the front-end (last modified: 2018.05.17).
 */
...
$CIDRAM['lang']['config_legal_omit_ua'] = 'Bỏ qua tác nhân người dùng từ nhật ký? True = Vâng; False = Không [Mặc định].';
