...
$CIDRAM['lang']['tip_hello'] = 'Olá, {username}.';
$CIDRAM['lang']['tip_login'] = 'Nome de usuário padrão: <span class="txtRd">admin</span> – Senha padrão: <span class="txtRd">password</span>';
$CIDRAM['lang']['tip_logs'] = 'Selecionar um arquivo de registro da lista abaixo para visualizar o conteúdo do arquivo de registro.';
