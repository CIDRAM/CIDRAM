...
$this->CIDRAM['ModuleResCache'][$Module] = function () {
    ...
    if (isset($this->CIDRAM['ExtrasHonoured']['ruri']) && $this->BlockInfo['rURI'] !== '') {
        ...
        if (
            $this->trigger(\preg_match('~(?:^|[/?])Telerik\.Web\.UI\.(?:DialogHandler|WebResource)\.a(?:spx|xd)(?:$|[/?])~i', $LCNrURI), $Exploit = 'CVE-2017-11317/CVE-2019-18935', '', $UnmarkCaptcha) || // 2024.10.30 mod 2025.08.15
            $this->trigger(\preg_match('~(?:^|[/?])\$\$\$call\$\$\$/wizard(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2025-48757', '', $UnmarkCaptcha) || // 2027.06.07
            $this->trigger(\preg_match('~(?:^|[/?])_ignition/(?:execute-solution|health-check)(?:$|[/?])~i', $LCNrURI), $Exploit = 'CVE-2021-3129', '', $UnmarkCaptcha) || // 2026.03.20 mod 2026.08.15
            $this->trigger(\preg_match('~(?:^|[/?])_profiler/latest(?:$|[/?])~i', $LCNrURI), $Exploit = 'CVE-2024-50340/CVE-2026-45072', '', $UnmarkCaptcha) || // 2026.08.15
            $this->trigger(\preg_match('~(?:^|[/?])actuator/jolokia(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2018-1000130', '', $UnmarkCaptcha) || // 2026.08.15
            $this->trigger(\preg_match('~(?:^|[/?])api/v1/(?:auto_)?login(?:$|[/?])~i', $LCNrURI), $Exploit = 'CVE-2026-33017/CVE-2026-9198', '', $UnmarkCaptcha) || // 2026.08.06
            $this->trigger(\preg_match('~(?:^|[/?])assets/images/accesson\.php[57]?(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2025-54068', '', $UnmarkCaptcha) || // 2026.03.11
            $this->trigger(\preg_match('~(?:^|[/?])cgi-bin/php5(?:$|[/?])~i', $LCNrURI), $Exploit = 'CVE-2012-1823', '', $UnmarkCaptcha) || // 2026.03.19
            $this->trigger(\preg_match('~(?:^|[/?])civicrm/packages/openflashchart/php-ofc-library/ofc_upload_image\.php[57]?(?:$|[/?])~', $LCNrURI), $Exploit = 'CIVI-SA-2013-001', '', $UnmarkCaptcha) || // 2025.07.05 mod 2025.08.07
            $this->trigger(\preg_match('~(?:^|[/?])dup-installer/main\.installer\.php[57]?(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2022-2551', '', $UnmarkCaptcha) || // 2024.09.05 mod 2025.08.07
            $this->trigger(\preg_match('~(?:^|[/?])ecp/current/exporttool/microsoft.exchange.ediscovery.exporttool.application(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2021-28481', '', $UnmarkCaptcha) || // 2025.07.17 mod 2025.08.07
            $this->trigger(\preg_match('~(?:^|[/?])elfinder/php/connector(?:\.minimal)?\.php[57]?(?:$|[/?])~', $LCNrURI), $Exploit = 'elFinder', '', $UnmarkCaptcha) || // 2025.07.07 mod 2025.11.06 (possible matches: CVE-2019-1010178, CVE-2020-25213, CVE-2020-35235, CVE-2021-32682)
            $this->trigger(\preg_match('~(?:^|[/?])fckeditor/editor/filemanager(?:$|[/?])~', $LCNrURI), $Exploit = 'FCKeditor', '', $UnmarkCaptcha) || // 2025.07.20 mod 2025.08.07
            $this->trigger(\preg_match('~(?:^|[/?])inc/admin/phpinfo\.php(?:$|[/?])~i', $LCNrURI), $Exploit = 'CVE-2014-4942', '', $UnmarkCaptcha) || // 2026.08.05
            $this->trigger(\preg_match('~(?:^|[/?])includes/openflashchart/php-ofc-library/ofc_upload_image\.php[57]?(?:$|[/?])~', $LCNrURI), $Exploit = 'SA53428', '', $UnmarkCaptcha) || // 2025.07.10 mod 2025.08.07
            $this->trigger(\preg_match('~(?:^|[/?])ipfs/bafkreicyqcbhpicbos7ev4mrxofwqx6hvvge7pahpta6xuspr44crai5by(?:$|[/?])~i', $LCNrURI), $Exploit = 'CVE-2016-10563', '', $UnmarkCaptcha) || // 2025.11.13
            $this->trigger(\preg_match('~(?:^|[/?])jobmanager/logs(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2020-17519', '', $UnmarkCaptcha) || // 2026.08.15
            $this->trigger(\preg_match('~(?:^|[/?])library/openflashchart/php-ofc-library/ofc_upload_image\.php[57]?(?:$|[/?])~', $LCNrURI), $Exploit = 'ZSL-2013-5126', '', $UnmarkCaptcha) || // 2025.07.10 mod 2025.08.07
            $this->trigger(\preg_match('~(?:^|[/?])modules/mod_footer/tmpl$~i', $LCNrURI), $Exploit = 'CVE-2021-26035', '', $UnmarkCaptcha) || // 2026.03.20
            $this->trigger(\preg_match('~(?:^|[/?])modules/mod_simplefileuploadv1\.3/elements(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2011-5148', '', $UnmarkCaptcha) || // 2025.07.20 mod 2025.08.07
            $this->trigger(\preg_match('~(?:^|[/?])tinymce/plugins/filemanager/dialog\.php[57]?(?:$|[/?])~', $LCNrURI), $Exploit = 'TinyMCE Filemanager', '', $UnmarkCaptcha) || // 2025.07.07 mod 2025.08.07
            $this->trigger(\preg_match('~(?:^|[/?])trace\.axd(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2025-54459', '', $UnmarkCaptcha) || // 2026.08.15
            $this->trigger(\preg_match('~(?:^|[/?])util/php/eval-stdin\.php[57]?(?:$|[/?])~', $LCNrURI), $Exploit = 'CVE-2017-9841', '', $UnmarkCaptcha) || // 2025.07.16 mod 2025.08.07
