...
- [2026.08.16]: At the IP testing page, when test results cite profiles, at the lines for any profiles generated by auxiliary rules, the auxiliary rules SVG has been added to make it easier to distinguish those profiles from profiles generated elsewhere.
- [2026.08.17]: At the IP testing page, when test results cite profiles, at the lines for any profiles generated by modules, the modules SVG has been added to make it easier to distinguish those profiles from profiles generated elsewhere, with a hover-over tooltip stating which specific module is responsible.
- *Plus all the regular signature updates.*
