 ...
 * @see LICENSE.txt
 *
 * This file: Russian language data for CLI (last modified: 2018.01.20).
 */
...
$CIDRAM['lang']['CLI_H'] = "
 ...
 Применение:
 php.exe /cidram/loader.php -Флаг (Ввод)
 ...
 Флаги: -h Покажи помощь информации.
        ...
        -v Проверить файл сигнатуры.
        -f Исправьте файл сигнатуры.
...
$CIDRAM['lang']['CLI_VL_Expiry'] = 'Л%s: Тег истечения не содержит действительный ISO 8601 дата/время!';
...
$CIDRAM['lang']['CLI_VL_Origin'] = 'Л%s: Тег происхождения не содержит действительного кода «ISO 3166-1 Alpha-2»!';
...
$CIDRAM['lang']['CLI_VL_Tags'] = 'Л%s: Тег секция больше 20 байт; Секция теги должны быть четкими и краткими.';
