 ...
 * @see LICENSE.txt
 *
 * This file: Portuguese language data for the front-end (last modified: 2019.01.07).
 */
...
$CIDRAM['lang']['Extended Description: Chart.js'] = 'Permite que o front-end gere gráficos de pizza.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> está disponível através do <a href="https://opensource.org/licenses/MIT">MIT license</a>.';
$CIDRAM['lang']['Extended Description: PHPMailer'] = 'Necessário para usar qualquer funcionalidade que envolva o envio de email.<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a> está disponível através do licença <a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a>.';
...
$CIDRAM['lang']['Extended Description: module_botua.php'] = 'Bloqueia os agentes do usuário associados a bots indesejados e atividades nefastas.';
...
$CIDRAM['lang']['Name: compat_bunnycdn.php'] = 'BunnyCDN módulo de compatibilidade';
...
$CIDRAM['lang']['Name: module_botua.php'] = 'Módulo de agentes do usuário opcional';
...
$CIDRAM['lang']['Name: module_ua.php'] = 'Módulo de bloqueador de UA vazio';
...
$CIDRAM['lang']['config_general_ban_override'] = 'Sobrepor "forbid_on_block" quando "infraction_limit" é excedido? Quando sobrepõe: As solicitações bloqueadas retornam uma página em branco (os arquivos de modelo não são usados). 200 = Não sobrepor [Padrão]. Outros valores são os mesmos que os valores disponíveis para "forbid_on_block".';
...
$CIDRAM['lang']['config_general_disable_webfonts'] = 'Desativar webfonts? True = Sim [Padrão]; False = Não.';
...
$CIDRAM['lang']['config_general_empty_fields'] = 'Como o CIDRAM deve manipular campos vazios ao registrar e exibir informações de eventos de bloco? "include" = Incluir campos vazios. "omit" = Omitir campos vazios [padrão].';
$CIDRAM['lang']['config_general_forbid_on_block'] = 'Qual mensagem de status HTTP deve enviar o CIDRAM ao bloquear solicitações? (Consulte a documentação para mais informações).';
...
$CIDRAM['lang']['config_legal_omit_hostname'] = 'Omitir nomes de host de logs? True = Sim; False = Não [Padrão].';
...
$CIDRAM['lang']['config_signatures_block_malware'] = 'Bloquear IPs associados ao malware? Isso inclui servidores C&C, máquinas infectadas, máquinas envolvidas na distribuição de malware, etc.';
...
$CIDRAM['lang']['field_Request_Method'] = 'Método de solicitação';
$CIDRAM['lang']['field_activate'] = 'Ativar';
$CIDRAM['lang']['field_add_more_conditions'] = 'Adicione mais condições';
...
$CIDRAM['lang']['field_include'] = 'Incluir campos vazios';
...
$CIDRAM['lang']['field_omit'] = 'Omitir campos vazios';
...
$CIDRAM['lang']['field_reasonmessage'] = 'Razão bloqueada (detalhado)';
...
$CIDRAM['lang']['field_ualc'] = 'Agente do usuário (minúscula)';
...
$CIDRAM['lang']['label_actual'] = 'Atual';
$CIDRAM['lang']['label_aux_actBlk'] = 'bloquear';
$CIDRAM['lang']['label_aux_actByp'] = 'contornar';
$CIDRAM['lang']['label_aux_actGrl'] = 'lista cinza';
$CIDRAM['lang']['label_aux_actWhl'] = 'lista branca';
$CIDRAM['lang']['label_aux_create_new_rule'] = 'Criar nova regra';
$CIDRAM['lang']['label_aux_logic_all'] = 'Para desencadear a regra, todas as condições devem ser cumpridas.';
$CIDRAM['lang']['label_aux_logic_any'] = 'Quaisquer condições "iguais" (=) podem desencadear a regra, desde que todas as condições "não iguais" (≠) também sejam cumpridas.';
$CIDRAM['lang']['label_aux_menu_action'] = 'Se as condições a seguir forem cumpridas, %s a solicitação.';
$CIDRAM['lang']['label_aux_menu_method'] = 'Use %s para testar as condições.';
$CIDRAM['lang']['label_aux_mtdReg'] = 'expressões regulares';
$CIDRAM['lang']['label_aux_mtdStr'] = 'comparação direta de string';
$CIDRAM['lang']['label_aux_mtdWin'] = 'curingas no estilo do Windows';
$CIDRAM['lang']['label_aux_name'] = 'Um nome para a nova regra:';
$CIDRAM['lang']['label_aux_reason'] = 'O motivo dado ao usuário quando bloqueado:';
$CIDRAM['lang']['label_backup_location'] = 'Locais de backup de repositório (em caso de emergência, ou se tudo o mais falhar):';
...
$CIDRAM['lang']['label_fmgr_other_sig'] = 'Outras regras, arquivos de assinatura, etc';
$CIDRAM['lang']['label_fmgr_safety'] = 'Mecanismos de segurança';
...
$CIDRAM['lang']['label_hide_hash_table'] = 'Ocultar tabela de hash';
$CIDRAM['lang']['label_ignore'] = 'Ignore isso';
...
$CIDRAM['lang']['label_show_by_origin'] = 'Mostrar por origem';
$CIDRAM['lang']['label_show_hash_table'] = 'Mostrar tabela de hash';
...
$CIDRAM['lang']['label_unignore'] = 'Não ignore isso';
...
$CIDRAM['lang']['link_aux'] = 'Regras Auxiliares';
...
$CIDRAM['lang']['response_2fa_invalid'] = 'Código 2FA incorreto inserido. Autenticação falhou.';
$CIDRAM['lang']['response_2fa_valid'] = 'Autenticado com sucesso.';
...
$CIDRAM['lang']['response_aux_none'] = 'Atualmente não há quaisquer regras auxiliares.';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = 'Nova regra auxiliar, "%s", criada com sucesso.';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = 'Regra auxiliar, "%s", deletada com sucesso.';
...
$CIDRAM['lang']['security_warning'] = 'Ocorreu um problema inesperado ao processar sua solicitação. Por favor, tente novamente. Se os problemas persistirem, entre em contato com o suporte.';
...
$CIDRAM['lang']['switch-tracking-aux-set-false'] = 'Não verifique contra regras auxiliares';
$CIDRAM['lang']['switch-tracking-aux-set-true'] = 'Verifique contra regras auxiliares';
...
$CIDRAM['lang']['tip_aux'] = 'Olá, {username}.<br />Você pode usar esta página para criar, deletar e modificar regras auxiliares para o CIDRAM.';
...
$CIDRAM['lang']['tip_condition_placeholder'] = 'Especifique um valor, ou deixe em branco para desconsiderar.';
...
$CIDRAM['lang']['tip_pie_html'] = 'Clique no nome do componente para mais detalhes.';
...
$CIDRAM['lang']['msg_subject_2fa'] = 'Autenticação de dois fatores';
