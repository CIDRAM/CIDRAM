 ...
 * @see LICENSE.txt
 *
 * This file: German language data for the front-end (last modified: 2019.01.07).
 */
...
foreach (['IPv4', 'IPv6'] as $CIDRAM['IPvX']) {
    $CIDRAM['Pre'] = 'Standard-' . $CIDRAM['IPvX'] . '-Signaturen normalerweise mit dem Hauptpaket enthalten. ';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX']] = $CIDRAM['Pre'] . 'Blockiert unerwünschte Cloud-Services und nicht-menschliche Endpunkte.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-Bogons'] = $CIDRAM['Pre'] . 'Blockiert Bogon/Marsmensch CIDRs.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-ISPs'] = $CIDRAM['Pre'] . 'Blockiert gefährliche und spam-anfällig ISPs.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-Other'] = $CIDRAM['Pre'] . 'Blockiert CIDRs für Proxies, VPNs und andere verschiedene unerwünschte Dienste.';
    $CIDRAM['Pre'] = $CIDRAM['IPvX'] . ' Signaturdatei (%s).';
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX']] = sprintf($CIDRAM['Pre'], 'unerwünschte Cloud-Services und nicht-menschliche Endpunkte');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-Bogons'] = sprintf($CIDRAM['Pre'], 'Bogon/Marsmensch CIDRs');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-ISPs'] = sprintf($CIDRAM['Pre'], 'gefährliche und spam-anfällig ISPs');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-Other'] = sprintf($CIDRAM['Pre'], 'CIDRs für Proxies, VPNs und andere verschiedene unerwünschte Dienste');
}
...
$CIDRAM['lang']['Name: module_baidublocker.php'] = 'Baidu Blocker-Modul';
$CIDRAM['lang']['Name: module_botua.php'] = 'Optionales Benutzeragenten-Modul';
$CIDRAM['lang']['Name: module_cookies.php'] = 'Optionales Cookie-Scanner-Modul';
$CIDRAM['lang']['Name: module_extras.php'] = 'Optionales Sicherheits-Extras-Modul';
$CIDRAM['lang']['Name: module_sfs.php'] = 'Stop Forum Spam Modul';
$CIDRAM['lang']['Name: module_ua.php'] = 'Leeres UA-Blocker-Modul';
...
$CIDRAM['lang']['field_Request_Method'] = 'Methode anfordern';
$CIDRAM['lang']['field_activate'] = 'Aktivieren';
$CIDRAM['lang']['field_add_more_conditions'] = 'Fügen Sie mehr Bedingungen';
...
$CIDRAM['lang']['field_delete'] = 'Löschen';
...
$CIDRAM['lang']['field_reasonmessage'] = 'Warum blockierte (detailliert)';
...
$CIDRAM['lang']['field_ualc'] = 'Benutzeragent (kleingeschrieben)';
...
$CIDRAM['lang']['label_aux_actBlk'] = 'blockieren';
$CIDRAM['lang']['label_aux_actByp'] = 'bypassen';
$CIDRAM['lang']['label_aux_actGrl'] = 'graue listet';
$CIDRAM['lang']['label_aux_actWhl'] = 'weiße listet';
$CIDRAM['lang']['label_aux_create_new_rule'] = 'Erstellen Sie eine neue Regel';
$CIDRAM['lang']['label_aux_logic_all'] = 'Um die Regel auszulösen, müssen alle Bedingungen erfüllt sein.';
$CIDRAM['lang']['label_aux_logic_any'] = 'Irgendwelche Bedingungen "gleich" (=) können die Regel auslösen, solange alle Bedingungen "nicht gleich" (≠) erfüllt sind.';
$CIDRAM['lang']['label_aux_menu_action'] = 'Wenn die folgenden Bedingungen erfüllt sind, %s Sie die Anfrage.';
$CIDRAM['lang']['label_aux_menu_method'] = 'Verwenden Sie %s, um die Bedingungen zu testen.';
$CIDRAM['lang']['label_aux_mtdReg'] = 'Reguläre Ausdrücke';
$CIDRAM['lang']['label_aux_mtdStr'] = 'direkter String Vergleich';
$CIDRAM['lang']['label_aux_mtdWin'] = 'Wildcards im Windows-Stil';
$CIDRAM['lang']['label_aux_name'] = 'Ein Name für die neue Regel:';
$CIDRAM['lang']['label_aux_reason'] = 'Der Grund, der dem Benutzer beim Blockiert gegeben wird:';
$CIDRAM['lang']['label_backup_location'] = 'Repository-Sicherungsspeicherorte (im Notfall, oder wenn alles andere fehlschlägt):';
...
$CIDRAM['lang']['label_check_aux'] = 'Testen Sie auch gegen Hilfsregeln.';
...
$CIDRAM['lang']['label_expected'] = 'Erwartet';
...
$CIDRAM['lang']['label_fmgr_other_sig'] = 'Andere Regeln, Signaturdateien, u.s.w.';
$CIDRAM['lang']['label_fmgr_safety'] = 'Sicherheitsmechanismen';
...
$CIDRAM['lang']['label_hide_hash_table'] = 'Hash-tabelle ausblenden';
$CIDRAM['lang']['label_ignore'] = 'Ignoriere';
...
$CIDRAM['lang']['label_unignore'] = 'Unignoriere';
$CIDRAM['lang']['label_unstable'] = 'Neueste instabil:';
$CIDRAM['lang']['label_used_with'] = 'Benutzt mit: ';
$CIDRAM['lang']['label_your_ip'] = 'Deine IP:';
$CIDRAM['lang']['label_your_ua'] = 'Deine UA:';
$CIDRAM['lang']['link_accounts'] = 'Konten';
$CIDRAM['lang']['link_aux'] = 'Hilfsregeln';
...
$CIDRAM['lang']['response_aux_none'] = 'Derzeit gibt es keine Hilfsregeln.';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = 'Neue Hilfsregel, "%s", wurde erfolgreich erstellt.';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = 'Hilfsregel, "%s", erfolgreich gelöscht.';
...
$CIDRAM['lang']['response_sanity_1'] = 'Datei enthält unerwarteten Inhalt! Datei abgelehnt!';
...
$CIDRAM['lang']['switch-tracking-aux-set-false'] = 'Nicht gegen Hilfsregeln überprüfen';
$CIDRAM['lang']['switch-tracking-aux-set-true'] = 'Gegen Hilfsregeln überprüfen';
...
$CIDRAM['lang']['tip_pie_html'] = 'Klicken Sie auf den Komponentennamen, um weitere Informationen zu erhalten.';
...
$CIDRAM['lang']['title_login'] = 'Einloggen';
...
$CIDRAM['lang']['info_some_useful_links'] = 'Einige nützliche Links:<ul>
      ...
      <li><a href="https://bgp.he.net/">Hurricane Electric BGP Toolkit</a> – Erhalten Sie CIDRs von ASNs, bestimmen Sie ASN-Beziehungen, entdecken Sie ASNs basierend auf Netzwerknamen, u.s.w.</li>
