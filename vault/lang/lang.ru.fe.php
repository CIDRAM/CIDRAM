...
$CIDRAM['lang']['Extended Description: Chart.js'] = 'Позволяет фронтенд создавать круговые диаграммы.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> доступен через <a href="https://opensource.org/licenses/MIT">MIT license</a>.';
$CIDRAM['lang']['Extended Description: PHPMailer'] = 'Требуется для использования любых функций, связанных с отправкой электронной почты.<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a> доступен через лицензию <a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a>.';
...
$CIDRAM['lang']['Extended Description: module_botua.php'] = 'Блокирует пользовательские агенты, связанные с нежелательными ботами и нечестной деятельностью.';
...
$CIDRAM['lang']['Name: compat_bunnycdn.php'] = 'Модуль совместимости BunnyCDN';
...
$CIDRAM['lang']['Name: module_botua.php'] = 'Модуль дополнительных пользовательских агентов';
...
$CIDRAM['lang']['Name: module_ua.php'] = 'Модуль блокировки UA пустой';
...
$CIDRAM['lang']['config_PHPMailer_Enable2FA'] = 'Эта директива включает/отключает использование 2FA для фронтенд счетов.';
$CIDRAM['lang']['config_PHPMailer_EventLog'] = 'Файл для регистрации всех событий в отношении PHPMailer. Задайте имя файлу, или оставьте пустым чтобы деактивировать опцию.';
$CIDRAM['lang']['config_PHPMailer_Host'] = 'Хост SMTP используется для исходящей электронной почты.';
$CIDRAM['lang']['config_PHPMailer_Password'] = 'Пароль для отправки электронной почты через SMTP.';
$CIDRAM['lang']['config_PHPMailer_Port'] = 'Номер порта для исходящей электронной почты. Стандарт = 587.';
$CIDRAM['lang']['config_PHPMailer_SMTPAuth'] = 'Эта директива включает/отключает аутентификацию сессия SMTP (обычно ее следует оставить в покое).';
$CIDRAM['lang']['config_PHPMailer_SMTPSecure'] = 'Протокол для при отправке электронной почты через SMTP (TLS или SSL).';
...
$CIDRAM['lang']['config_PHPMailer_Username'] = 'Имя пользователя для отправки электронной почты через SMTP.';
$CIDRAM['lang']['config_PHPMailer_addReplyToAddress'] = 'Адрес ответа для отправки электронной почты через SMTP.';
$CIDRAM['lang']['config_PHPMailer_addReplyToName'] = 'Имя ответа для отправки электронной почты через SMTP.';
$CIDRAM['lang']['config_PHPMailer_setFromAddress'] = 'Адрес отправителя для отправки электронной почты через SMTP.';
$CIDRAM['lang']['config_PHPMailer_setFromName'] = 'Имя отправителя для отправки электронной почты через SMTP.';
$CIDRAM['lang']['config_experimental'] = 'Нестабильный/Экспериментальный!';
...
$CIDRAM['lang']['config_general_social_media_verification'] = 'Попытка проверить запросы в социальных сетях? Проверка социальных сетей обеспечивает защиту от поддельных запросов в социальных сетях (такие запросы будут заблокированы). True = Активировать проверку социальных сетей [Стандарт]; False = Деактивировать проверку социальных сетей.';
...
$CIDRAM['lang']['config_legal_pseudonymise_ip_addresses'] = 'Псевдонимный IP-адреса при записи файлов журнала? True = Да [Стандарт]; False = Нет.';
...
$CIDRAM['lang']['config_signatures_block_legal'] = 'Блокировать CIDRs в ответ на юридические обязательства? Эта директива обычно не должна иметь никакого эффекта, поскольку CIDRAM не связывает CIDR с «юридическими обязательствами» по умолчанию, но тем не менее он существует как дополнительная контрольная мера в интересах любых пользовательских файлов сигнатуры или модулей, которые могут существовать по юридическим причинам.';
$CIDRAM['lang']['config_signatures_block_malware'] = 'Блокировать IP-адреса, связанные с вредоносным программы? Это включает в себя серверы C&C; зараженные машины; машины, участвующие в распространении вредоносных программ; и т.д.';
...
$CIDRAM['lang']['field_reasonmessage'] = 'Почему Заблокированные (подробный)';
...
$CIDRAM['lang']['field_ualc'] = 'Агент пользователя (в нижнем регистре)';
...
$CIDRAM['lang']['label_aux_logic_any'] = 'Любые условия «равно» (=) могут вызвать правило, если все условия «не равны» (≠) также соблюдены.';
$CIDRAM['lang']['label_aux_menu_action'] = 'Если выполнены следующие условия, %s запрос.';
$CIDRAM['lang']['label_aux_menu_method'] = 'Используйте %s для проверки условий.';
$CIDRAM['lang']['label_aux_mtdReg'] = 'регулярное выражения';
$CIDRAM['lang']['label_aux_mtdStr'] = 'прямых сравнение строк';
$CIDRAM['lang']['label_aux_mtdWin'] = 'подстановочные знаки в стиле Windows';
$CIDRAM['lang']['label_aux_name'] = 'Имя нового правила:';
$CIDRAM['lang']['label_aux_reason'] = 'Причина, данная пользователю при блокировке:';
...
$CIDRAM['lang']['label_check_aux'] = 'Также протестируйте дополнительные правила.';
...
$CIDRAM['lang']['label_fmgr_other_sig'] = 'Другие правила, файлы сигнатуры и т.д.';
$CIDRAM['lang']['label_fmgr_safety'] = 'Механизмы безопасности';
...
$CIDRAM['lang']['label_unignore'] = 'Не игнорировать это';
...
$CIDRAM['lang']['link_aux'] = 'Вспомогательные Правила';
...
$CIDRAM['lang']['response_2fa_invalid'] = 'Введен неправильный код 2FA. Ошибка аутентификации.';
$CIDRAM['lang']['response_2fa_valid'] = 'Успешный аутентификации.';
...
$CIDRAM['lang']['response_aux_none'] = 'В настоящее время нет вспомогательных правил.';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = 'Новое вспомогательное правило, "%s", создано успешно.';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = 'Вспомогательное правило, "%s", удалено успешно.';
...
$CIDRAM['lang']['state_sl_totals'] = 'Сумма (Сигнатуры: <span class="txtRd">%s</span> – Секции сигнатуры: <span class="txtRd">%s</span> – Файлы сигнатуры: <span class="txtRd">%s</span> – Уникальные теги секций: <span class="txtRd">%s</span>).';
...
$CIDRAM['lang']['tip_aux'] = 'Привет, {username}.<br />Вы можете использовать эту страницу для создания, удаления и изменения вспомогательных правил для CIDRAM.';
...
$CIDRAM['lang']['tip_condition_placeholder'] = 'Укажите значение, или оставьте пустым, чтобы игнорировать.';
...
$CIDRAM['lang']['tip_ip_test_switches'] = '(Если не выбрано, будут проверяться только файлы сигнатуры).';
...
$CIDRAM['lang']['tip_pie_html'] = 'Нажмите на название компонента для получения более подробной информации.';
...
$CIDRAM['lang']['info_some_useful_links'] = 'Некоторые полезные ссылки:<ul>
      ...
      <li><a href="https://bgp.he.net/">Hurricane Electric BGP Toolkit</a> – Получить CIDRs от ASNs, определить ASN отношения, обнаружить ASNs основанный на сетевых имен, и т.д.</li>
      ...
      <li><a href="https://maikuolan.github.io/Vulnerability-Charts/">Таблицы Уязвимостей</a> – Список безопасных/небезопасных версий различных пакетов (HHVM, PHP, phpMyAdmin, Python, и т.д.).</li>
...
$CIDRAM['lang']['msg_template_2fa'] = '<center><p>Привет, %1$s.<br />
<br />
Ваш код 2FA для входа в интерфейс CIDRAM:</p>
<h1>%2$s</h1>
<p>Этот код истекает через 10 минут.</p></center>';
$CIDRAM['lang']['msg_subject_2fa'] = 'Двухфакторная аутентификация';
