...
foreach (['IPv4', 'IPv6'] as $CIDRAM['IPvX']) {
    $CIDRAM['Pre'] = 'Standard ' . $CIDRAM['IPvX'] . '-signaturerna ingår normalt i huvudpaketet. ';
...
$CIDRAM['lang']['Extended Description: Chart.js'] = 'Gör det möjligt för framsidan att generera cirkeldiagram.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> är tillgängligt via <a href="https://opensource.org/licenses/MIT">MIT license</a>.';
$CIDRAM['lang']['Extended Description: PHPMailer'] = 'Krävs för att använda någon funktionalitet som involverar att skicka e-post.<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a> är tillgängligt via <a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a>-licensen.';
$CIDRAM['lang']['Extended Description: module_badhosts.php'] = 'Blockar värdar som ofta används av spammare, hackare och andra skändlig enheter.';
$CIDRAM['lang']['Extended Description: module_badhosts_isps.php'] = 'Blockerar värdar som tillhör internetleverantörer som ofta används av spammare, hackare och andra skändlig enheter.';
$CIDRAM['lang']['Extended Description: module_badtlds.php'] = 'Blockerar värdar som tillhör toppdomäner som ofta används av spammare, hackare och andra skändlig enheter.';
$CIDRAM['lang']['Extended Description: module_botua.php'] = 'Blockerar användaragenter associerade med oönskade bots och nöjesaktivitet.';
...
$CIDRAM['lang']['Name: module_badtlds.php'] = 'Dåliga toppdomäner blockeringsmodul';
$CIDRAM['lang']['Name: module_baidublocker.php'] = 'Baidu blockeringsmodul';
$CIDRAM['lang']['Name: module_botua.php'] = 'Valfri användaragentmodul';
...
$CIDRAM['lang']['Name: module_ua.php'] = 'Tom UA-blockeringsmodul';
...
$CIDRAM['lang']['config_legal_pseudonymise_ip_addresses'] = 'Pseudonymisera IP-adresser när loggning? True = Ja [Standard]; False = Nej.';
$CIDRAM['lang']['config_rate_limiting_allowance_period'] = 'Antalet timmar att spåra användningen. Standard = 0.';
$CIDRAM['lang']['config_rate_limiting_max_bandwidth'] = 'Den maximala bandbreddsmängden som tillåts inom tillåten-perioden före hastighetsbegränsar framtida förfrågningar. Ett värde av 0 avaktiverar denna typ av hastighetsbegränsande. Standard = 0KB.';
$CIDRAM['lang']['config_rate_limiting_max_requests'] = 'Det maximala antalet förfrågningar som tillåts inom tillåten-perioden före hastighetsbegränsar framtida förfrågningar. Ett värde av 0 avaktiverar denna typ av hastighetsbegränsande. Standard = 0.';
$CIDRAM['lang']['config_rate_limiting_precision_ipv4'] = 'Den precision som ska användas för att spåra IPv4-användning. Värdet speglar CIDR-blockstorleken. Ställ in till 32 för bästa precision. Standard = 32.';
$CIDRAM['lang']['config_rate_limiting_precision_ipv6'] = 'Den precision som ska användas för att spåra IPv6-användning. Värdet speglar CIDR-blockstorleken. Ställ in till 128 för bästa precision. Standard = 128.';
...
$CIDRAM['lang']['config_signatures_block_malware'] = 'Blockera IP-adresser i samband med skadlig kod? Detta inkluderar C&C-servrar, infekterade maskiner, maskiner som är involverade i distribution av skadlig kod, osv.';
...
$CIDRAM['lang']['field_delete'] = 'Radera';
...
$CIDRAM['lang']['field_reasonmessage'] = 'Varför Blockeras (detaljerad)';
...
$CIDRAM['lang']['field_ualc'] = 'Användaragent (små bokstäver)';
...
$CIDRAM['lang']['label_actual'] = 'Aktuell';
...
$CIDRAM['lang']['label_aux_logic_any'] = 'Eventuella "lika" (=) villkor kan utlösa regeln, så länge som alla "inte lika" (≠) villkor också uppfylls.';
$CIDRAM['lang']['label_aux_menu_action'] = 'Om följande villkor är uppfyllda, %s begäran.';
$CIDRAM['lang']['label_aux_menu_method'] = 'Använd %s för att testa villkoren.';
$CIDRAM['lang']['label_aux_mtdReg'] = 'regelbunden uttryck';
$CIDRAM['lang']['label_aux_mtdStr'] = 'direkt sträng jämförelse';
$CIDRAM['lang']['label_aux_mtdWin'] = 'Windows-vildkort';
$CIDRAM['lang']['label_aux_name'] = 'Ett namn på den nya regeln:';
$CIDRAM['lang']['label_aux_reason'] = 'Anledningen till användaren när den blockeras:';
$CIDRAM['lang']['label_backup_location'] = 'Repository backup platser (i nödfall, eller om allt annat misslyckas):';
...
$CIDRAM['lang']['label_expected'] = 'Förväntad';
...
$CIDRAM['lang']['link_range'] = 'Range Tabeller';
...
$CIDRAM['lang']['response_aux_none'] = 'Det finns för närvarande inga hjälpregler.';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = 'Ny hjälpregel, "%s", skapades framgångsrikt.';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = 'Hjälpregel, "%s", raderas framgångsrikt.';
...
$CIDRAM['lang']['state_email_sent'] = 'E-post skickades framgångsrikt till "%s".';
$CIDRAM['lang']['state_failed_missing'] = 'Uppgiften misslyckades eftersom en nödvändig komponent inte är tillgänglig.';
...
$CIDRAM['lang']['state_logged_in_2fa_pending'] = 'Inloggad + 2FA väntar.';
$CIDRAM['lang']['state_logged_out'] = 'Utloggad.';
...
$CIDRAM['lang']['tip_aux'] = 'Hallå, {username}.<br />Du kan använda den här sidan för att skapa, ta bort och ändra hjälpregler för CIDRAM.';
...
$CIDRAM['lang']['tip_condition_placeholder'] = 'Ange ett värde, eller lämna tomma för att bortse från.';
...
$CIDRAM['lang']['tip_ip_test_switches'] = '(När den inte är vald, endast signaturfiler kommer att testas mot).';
...
$CIDRAM['lang']['title_login'] = 'Inloggning';
