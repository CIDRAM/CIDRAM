...
$CIDRAM['lang']['Extended Description: Chart.js'] = 'Enables the front-end to generate pie charts.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> is available via the <a href="https://opensource.org/licenses/MIT">MIT license</a>.';
$CIDRAM['lang']['Extended Description: PHPMailer'] = 'Required for using any functionality that involves sending email.<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a> is available via the <a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a> license.';
...
$CIDRAM['lang']['Name: compat_bunnycdn.php'] = 'BunnyCDN compatibility module';
...
$CIDRAM['lang']['field_add_more_conditions'] = 'Add more conditions';
...
$CIDRAM['lang']['field_reasonmessage'] = 'Why Blocked (detailed)';
...
$CIDRAM['lang']['field_ualc'] = 'User Agent (lower-case)';
...
$CIDRAM['lang']['label_aux_actBlk'] = 'block';
$CIDRAM['lang']['label_aux_actByp'] = 'bypass';
$CIDRAM['lang']['label_aux_actGrl'] = 'greylist';
$CIDRAM['lang']['label_aux_actWhl'] = 'whitelist';
$CIDRAM['lang']['label_aux_create_new_rule'] = 'Create new rule';
$CIDRAM['lang']['label_aux_logic_all'] = 'In order to trigger the rule, all conditions must be met.';
$CIDRAM['lang']['label_aux_logic_any'] = 'Any "equals" (=) conditions may trigger the rule, as long as all "not equals" (≠) conditions are also met.';
$CIDRAM['lang']['label_aux_menu_action'] = 'If the following conditions are met, %s the request.';
$CIDRAM['lang']['label_aux_menu_method'] = 'Use %s to test the conditions.';
$CIDRAM['lang']['label_aux_mtdReg'] = 'regular expressions';
$CIDRAM['lang']['label_aux_mtdStr'] = 'direct string comparison';
$CIDRAM['lang']['label_aux_mtdWin'] = 'Windows-style wildcards';
$CIDRAM['lang']['label_aux_name'] = 'A name for the new rule:';
$CIDRAM['lang']['label_aux_reason'] = 'The reason given to the user when blocked:';
...
$CIDRAM['lang']['label_check_aux'] = 'Also test against auxiliary rules.';
...
$CIDRAM['lang']['label_expected'] = 'Expected';
...
$CIDRAM['lang']['label_hide_hash_table'] = 'Hide hash table';
$CIDRAM['lang']['label_ignore'] = 'Ignore this';
...
$CIDRAM['lang']['label_show_by_origin'] = 'Show by origin';
$CIDRAM['lang']['label_show_hash_table'] = 'Show hash table';
...
$CIDRAM['lang']['label_unignore'] = 'Unignore this';
...
$CIDRAM['lang']['link_aux'] = 'Auxiliary Rules';
...
$CIDRAM['lang']['response_2fa_invalid'] = 'Incorrect 2FA code entered. Authentication failed.';
$CIDRAM['lang']['response_2fa_valid'] = 'Successfully authenticated.';
...
$CIDRAM['lang']['response_aux_none'] = 'There aren\'t currently any auxiliary rules.';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = 'New auxiliary rule, "%s", created successfully.';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = 'Auxiliary rule, "%s", deleted successfully.';
...
$CIDRAM['lang']['security_warning'] = 'An unexpected problem occurred while processing your request. Please try again. If problems persist, contact support.';
...
$CIDRAM['lang']['switch-tracking-aux-set-false'] = 'Don\'t check against auxiliary rules';
$CIDRAM['lang']['switch-tracking-aux-set-true'] = 'Check against auxiliary rules';
...
$CIDRAM['lang']['tip_aux'] = 'Hello, {username}.<br />You can use this page to create, delete, and modify auxiliary rules for CIDRAM.';
...
$CIDRAM['lang']['tip_condition_placeholder'] = 'Specify a value, or leave blank to disregard.';
...
$CIDRAM['lang']['tip_ip_test_switches'] = '(When not selected, only the signature files will be tested against).';
...
$CIDRAM['lang']['info_some_useful_links'] = 'Some useful links:<ul>
      ...
      <li><a href="https://bgp.he.net/">Hurricane Electric BGP Toolkit</a> – Get CIDRs from ASNs, determine ASN relationships, discover ASNs based upon network names, etc.</li>
