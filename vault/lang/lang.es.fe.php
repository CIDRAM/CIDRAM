...
foreach (['IPv4', 'IPv6'] as $CIDRAM['IPvX']) {
    $CIDRAM['Pre'] = 'Firmas estándar ' . $CIDRAM['IPvX'] . ' normalmente se incluyen con el paquete principal. ';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX']] = $CIDRAM['Pre'] . 'Bloquea los servicios en la nube no deseados y puntos finales no humanos.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-Bogons'] = $CIDRAM['Pre'] . 'Bloquea bogon/marciano CIDRs.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-ISPs'] = $CIDRAM['Pre'] . 'Bloquea ISPs peligroso y propenso a spam.';
    $CIDRAM['lang']['Extended Description: ' . $CIDRAM['IPvX'] . '-Other'] = $CIDRAM['Pre'] . 'Bloquea CIDRs para proxies, VPNs y otros servicios misceláneos no deseados.';
    $CIDRAM['Pre'] = 'Archivo de firmas por ' . $CIDRAM['IPvX'] . ' (%s).';
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX']] = sprintf($CIDRAM['Pre'], 'servicios en la nube no deseados y puntos finales no humanos');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-Bogons'] = sprintf($CIDRAM['Pre'], 'bogon/marciano CIDRs');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-ISPs'] = sprintf($CIDRAM['Pre'], 'ISPs peligroso y propenso a spam');
    $CIDRAM['lang']['Name: ' . $CIDRAM['IPvX'] . '-Other'] = sprintf($CIDRAM['Pre'], 'CIDRs para proxies, VPNs y otros servicios misceláneos no deseados');
}
...
$CIDRAM['lang']['Extended Description: Chart.js'] = 'Permite que el front-end genere gráficos circulares.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> está disponible a través de <a href="https://opensource.org/licenses/MIT">MIT license</a>.';
$CIDRAM['lang']['Extended Description: PHPMailer'] = 'Requerido para usar cualquier funcionalidad que implique el envío de correo electrónico.<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a> está disponible a través de la licencia <a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a>.';
...
$CIDRAM['lang']['Name: compat_bunnycdn.php'] = 'BunnyCDN módulo de compatibilidad';
...
$CIDRAM['lang']['config_PHPMailer_Enable2FA'] = 'Esta directiva determina si se debe usar 2FA para las cuentas del front-end.';
$CIDRAM['lang']['config_PHPMailer_EventLog'] = 'Un archivo para registrar todos los eventos en relación con PHPMailer. Especificar el nombre del archivo, o dejar en blanco para desactivar.';
$CIDRAM['lang']['config_PHPMailer_Host'] = 'El host SMTP para usar para el correo electrónico saliente.';
$CIDRAM['lang']['config_PHPMailer_Password'] = 'La contraseña a usar cuando se envía un correo electrónico a través de SMTP.';
$CIDRAM['lang']['config_PHPMailer_Port'] = 'El número de puerto a usar para el correo electrónico saliente. Predefinido = 587.';
$CIDRAM['lang']['config_PHPMailer_SMTPAuth'] = 'Esta directiva determina si autenticar sesiones SMTP (generalmente debería dejarse solo).';
$CIDRAM['lang']['config_PHPMailer_SMTPSecure'] = 'El protocolo a usar cuando se envía un correo electrónico a través de SMTP (TLS o SSL).';
...
$CIDRAM['lang']['config_PHPMailer_Username'] = 'El nombre de usuario a usar cuando se envía un correo electrónico a través de SMTP.';
$CIDRAM['lang']['config_PHPMailer_addReplyToAddress'] = 'La dirección de la respuesta para citar cuando se envía un correo electrónico a través de SMTP.';
$CIDRAM['lang']['config_PHPMailer_addReplyToName'] = 'El nombre de la respuesta para citar cuando se envía un correo electrónico a través de SMTP.';
$CIDRAM['lang']['config_PHPMailer_setFromAddress'] = 'La dirección del remitente para citar cuando se envía un correo electrónico a través de SMTP.';
$CIDRAM['lang']['config_PHPMailer_setFromName'] = 'El nombre del remitente para citar cuando se envía un correo electrónico a través de SMTP.';
$CIDRAM['lang']['config_experimental'] = '¡Inestable/Experimental!';
...
$CIDRAM['lang']['config_general_disable_webfonts'] = '¿Desactivar webfonts? True = Sí [Predefinido]; False = No.';
...
$CIDRAM['lang']['config_general_emailaddr_display_style'] = '¿Cómo prefieres que la dirección de correo electrónico sea presentada a los usuarios?';
$CIDRAM['lang']['config_general_empty_fields'] = '¿Cómo debe manejar CIDRAM los campos vacíos al registrar y mostrar información de eventos de bloque? "include" = Incluye los campos vacíos. "omit" = Omita los campos vacíos [predefinido].';
...
$CIDRAM['lang']['config_recaptcha_signature_limit'] = 'Número máximo de firmas permitidas para se desencadena cuando se ofrece una instancia de reCAPTCHA. Predefinido = 1. Si se excede este número para cualquier solicitud particular, no se ofrecerá una instancia de reCAPTCHA.';
...
$CIDRAM['lang']['config_signatures_block_legal'] = '¿Bloquear CIDRs en respuesta a obligaciones legales? Esta directiva normalmente no debería tener ningún efecto, porque CIDRAM no asocia ningún CIDR con "obligaciones legales" como estándar, pero existe aunque como una medida de control adicional en beneficio de cualquier archivo de firmas o módulo personalizado que pueda existir por razones legales.';
$CIDRAM['lang']['config_signatures_block_malware'] = '¿Bloquear las direcciones IP asociadas con el malware? Esto incluye servidores de C&C, máquinas infectadas, máquinas involucradas en la distribución de malware, etc.';
...
$CIDRAM['lang']['field_include'] = 'Incluye los campos vacíos';
...
$CIDRAM['lang']['field_omit'] = 'Omita los campos vacíos';
...
$CIDRAM['lang']['field_reasonmessage'] = 'Razón Bloqueado (detallado)';
...
$CIDRAM['lang']['field_ualc'] = 'Agente de Usuario (minúscula)';
...
$CIDRAM['lang']['field_verify'] = 'Verificar';
$CIDRAM['lang']['field_verify_all'] = 'Verificar todo';
...
$CIDRAM['lang']['label_actual'] = 'Actual';
...
$CIDRAM['lang']['label_aux_logic_any'] = 'Cualquier condición "igual" (=) puede desencadenar la regla, siempre y cuando también se cumplan todas las condiciones "no iguales" (≠).';
$CIDRAM['lang']['label_aux_menu_action'] = 'Si se cumplen las siguientes condiciones, %s la solicitud.';
$CIDRAM['lang']['label_aux_menu_method'] = 'Usa %s para probar las condiciones.';
$CIDRAM['lang']['label_aux_mtdReg'] = 'expresiones regulares';
$CIDRAM['lang']['label_aux_mtdStr'] = 'comparación directa de cadenas';
$CIDRAM['lang']['label_aux_mtdWin'] = 'comodines estilo Windows';
$CIDRAM['lang']['label_aux_name'] = 'Un nombre para la nueva regla:';
$CIDRAM['lang']['label_aux_reason'] = 'El motivo dado al usuario cuando está bloqueado:';
$CIDRAM['lang']['label_backup_location'] = 'Ubicaciones de copia de seguridad del repositorio (en caso de emergencia, o si todo lo demás falla):';
...
$CIDRAM['lang']['label_check_aux'] = 'También prueba contra reglas auxiliares.';
...
$CIDRAM['lang']['label_expected'] = 'Esperado';
...
$CIDRAM['lang']['label_hide_hash_table'] = 'Ocultar tabla hash';
$CIDRAM['lang']['label_ignore'] = 'Ignora esto';
...
$CIDRAM['lang']['label_show_by_origin'] = 'Mostrar por origen';
$CIDRAM['lang']['label_show_hash_table'] = 'Mostrar tabla hash';
$CIDRAM['lang']['label_signature_type'] = 'Tipo de firma:';
...
$CIDRAM['lang']['link_range'] = 'Tablas de Rango';
$CIDRAM['lang']['link_sections_list'] = 'Lista de Secciones';
...
$CIDRAM['lang']['response_2fa_invalid'] = 'Código de 2FA incorrecto ingresado. Autenticación fallida.';
$CIDRAM['lang']['response_2fa_valid'] = 'Autenticado con éxito.';
...
$CIDRAM['lang']['response_aux_none'] = 'Actualmente no hay ninguna reglas auxiliares.';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = 'Nueva regla auxiliar, "%s", creada con éxito.';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = 'Regla auxiliar, "%s", eliminada con éxito.';
...
$CIDRAM['lang']['response_sanity_1'] = '¡El archivo contiene contenido inesperado! Archivo rechazado!';
...
$CIDRAM['lang']['state_email_sent'] = 'Correo electrónico enviado con éxito a "%s".';
$CIDRAM['lang']['state_failed_missing'] = 'La tarea falló porque un componente necesario no está disponible.';
$CIDRAM['lang']['state_ignored'] = 'Ignorado';
$CIDRAM['lang']['state_loading'] = 'Cargando...';
...
$CIDRAM['lang']['state_logged_in_2fa_pending'] = 'Conectado + 2FA pendiente.';
...
$CIDRAM['lang']['state_sl_totals'] = 'Totales (Firmas: <span class="txtRd">%s</span> – Secciones de firma: <span class="txtRd">%s</span> – Archivos de firma: <span class="txtRd">%s</span> – Etiquetas de sección únicas: <span class="txtRd">%s</span>).';
...
$CIDRAM['lang']['switch-tracking-aux-set-false'] = 'No comparar con las reglas auxiliares';
$CIDRAM['lang']['switch-tracking-aux-set-true'] = 'Comparar con las reglas auxiliares';
...
$CIDRAM['lang']['tip_aux'] = 'Hola, {username}.<br />Puede usar esta página para crear, borrar y modificar reglas auxiliares para CIDRAM.';
...
$CIDRAM['lang']['tip_condition_placeholder'] = 'Especifique un valor, o déjelo en blanco para descartarlo.';
...
$CIDRAM['lang']['tip_fe_cookie_warning'] = 'Nota: CIDRAM usa una cookie para autenticar los inicios de sesión. Al iniciar sesión, usted da su consentimiento para que su navegador cree y almacene una cookie.';
...
$CIDRAM['lang']['tip_ip_test_switches'] = '(Cuando no se selecciona, solo los archivos de firma se probarán contra).';
...
$CIDRAM['lang']['msg_template_2fa'] = '<center><p>Hola, %1$s.<br />
<br />
...
$CIDRAM['lang']['msg_subject_2fa'] = 'Autenticación de dos factores';
