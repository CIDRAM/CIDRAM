...
$CIDRAM['lang']['config_general_truncate'] = 'وہ ایک خاص سائز تک پہنچنے میں جب صاف لاگ مسلیں؟ ویلیو میں KB زیادہ سے زیادہ سائز ہے. جب 0، وہ غیر معینہ مدت تک ترقی کر سکتا ہے (پہلے سے طے). نوٹ: واحد فائلوں پر لاگو ہوتا ہے! فائلیں اجتماعی غور نہیں کر رہے ہیں.';
...
$CIDRAM['lang']['config_recaptcha_logfile'] = 'مام reCAPTCHA کے کوششوں لاگ؟ اگر ہاں، logfile پر کے لئے استعمال کرنے کا نام کی وضاحت. کوئی تو اس متغیر خالی چھوڑ.';
$CIDRAM['lang']['config_recaptcha_secret'] = 'یہ قدر جس reCAPTCHA کے ڈیش بورڈ کے اندر اندر پایا جا سکتا ہے آپ کے reCAPTCHA کے لئے "خفیہ کلید"، کے مطابق ہونا چاہیے.';
$CIDRAM['lang']['config_recaptcha_sitekey'] = 'یہ قدر آپ ہیتی، جس reCAPTCHA کے ڈیش بورڈ کے اندر اندر پایا جا سکتا ہے کے لئے "سائٹ کلید" کے مطابق کرنا چاہئے';
...
$CIDRAM['lang']['config_signatures_modules'] = 'ماڈیول فائلوں کی ایک فہرست کوما سے ختم ہونے والی، IPv4 کی / IPv6 دستخط جانچ پڑتال کے بعد لوڈ کرنے کے لئے.';
...
$CIDRAM['lang']['info_some_useful_links'] = 'کچھ مفید لنکس:<ul>
            ...
            <li><a href="http://www.abuseat.org/asn.html">abuseat.org \'ے جامع مسدود کی فہرست</a> – ASNs لئے کی botnet انفیکشن کی شرح کے حوالے سے دکھاتا رپورٹیں.</li>
            ...
            <li><a href="https://www.megarbl.net/index.php">MegaRBL.net</a> – نام سے جانا جاتا spammers کو کی لسٹنگ برقرار رکھتا ہے؛ آئی پی / ASN کو فضول سرگرمیوں کی جانچ پڑتال کے لیے مفید.</li>
        </ul>';
