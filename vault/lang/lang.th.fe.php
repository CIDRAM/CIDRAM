 ...
 * @see LICENSE.txt
 *
 * This file: Thai language data for the front-end (last modified: 2017.04.11).
 */
...
$CIDRAM['lang']['config_general_timeFormat'] = 'รูปแบบสัญกรณ์สำหรับวันและเวลาใช้โดย CIDRAM. เลือกตัวเลือกจากรายการด้านล่าง. ตัวเลือกเพิ่มเติมอาจเพิ่มเมื่อมีการร้องขอ.';
