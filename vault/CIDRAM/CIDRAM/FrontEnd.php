...
class FrontEnd extends Core
{
    ...
    public function view(): void
    {
        ...
        $this->FE['PermissionsMap'] = $this->flagIntToArray(['Complete access' => false, 'Logs' => false, 'Statistics' => false, 'IP Testing' => false, 'Range tools' => false], $this->FE['Permissions']);
        ...
        if ($this->FE['UserState'] === 1) {
            ...
            if (empty($RemoteYAMLPHP)) {
                ...
                /** PHP latest stable. */
                $this->FE['info_php_stable'] = $RemoteYAMLPHPArray['Stable'] ?? $this->L10N->getString('response.Error');

                /** PHP latest unstable. */
                $this->FE['info_php_unstable'] = $RemoteYAMLPHPArray['Unstable'] ?? $this->L10N->getString('response.Error');
