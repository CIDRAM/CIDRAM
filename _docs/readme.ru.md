...
- Разрешить поиск gethostbyaddr, когда UDP недоступен? True = Да [Стандарт]; False = Нет. *Примечание: IPv6 не поддерживается gethostbyaddr.*
...
Последнее обновление: 27 Декабрь 2017 (2017.12.27).
