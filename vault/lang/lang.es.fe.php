 ...
 * @see LICENSE.txt
 *
 * This file: Spanish language data for the front-end (last modified: 2017.01.12).
 */
...
$CIDRAM['lang']['config_general_default_dns'] = 'Servidor DNS predefinido que se utiliza para las búsquedas de nombres del host. Predefinido = 8.8.8.8 (Google DNS). AVISO: No cambie esto a menos que sepas lo que estás haciendo!';
...
$CIDRAM['lang']['info_some_useful_links'] = 'Algunos enlaces útiles:<ul>
            ...
            <li><a href="https://macmathan.info/blocklists">MacMathan.info Range Blocks</a> – Contiene bloques de rangos opcionales que se pueden agregar a CIDRAM para bloquear cualquier país no deseado de acceder a su sitio web.</li>
