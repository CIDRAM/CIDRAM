...
$CIDRAM['lang']['config_PHPMailer_Enable2FA'] = 'এই নির্দেশটি ফ্রন্ট-এন্ড অ্যাকাউন্টগুলির জন্য 2FA ব্যবহার করে কিনা তা নির্ধারণ করে।';
$CIDRAM['lang']['config_PHPMailer_EventLog'] = 'PHPMailer সম্পর্কিত সকল ঘটনা লগইন করার জন্য একটি ফাইল। ফাইলের নাম উল্লেখ করুন, অথবা নিষ্ক্রিয় করতে ফাঁকা রাখুন।';
$CIDRAM['lang']['config_PHPMailer_Host'] = 'আউটবাউন্ড ইমেলের জন্য SMTP হোস্ট ব্যবহার করতে হবে।';
$CIDRAM['lang']['config_PHPMailer_Password'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য পাসওয়ার্ডটি।';
$CIDRAM['lang']['config_PHPMailer_Port'] = 'আউটবাউন্ড ইমেলের জন্য ব্যবহার করার জন্য পোর্ট নাম্বার। ডিফল্ট = "587"।';
$CIDRAM['lang']['config_PHPMailer_SMTPAuth'] = 'এই নির্দেশটি SMTP সেশনের প্রমাণীকরণ কিনা তা নির্ধারণ করে (সাধারণত এই একা ছেড়ে দেওয়া উচিত)।';
$CIDRAM['lang']['config_PHPMailer_SMTPSecure'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য প্রোটোকল (TLS বা SSL)।';
$CIDRAM['lang']['config_PHPMailer_SkipAuthProcess'] = 'যখন <code>true</code>, PHPMailer এসএমটিপি এর মাধ্যমে ইমেল পাঠানোর সাথে সাথে প্রমাণীকরণের প্রক্রিয়াটিকে সাধারণত ছাড় দেয়। এই এড়ানো উচিত, কারণ বহির্গামী ইমেল MITM আক্রমনের সম্মুখীন হতে পারে। তবে, এটি কিছু ক্ষেত্রে প্রয়োজনীয় হতে পারে (যেমন, যখন PHPMailer একটি SMTP সার্ভারে সংযোগ করতে পারবে না)।';
$CIDRAM['lang']['config_PHPMailer_Username'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য ব্যবহারকারীর নাম।';
$CIDRAM['lang']['config_PHPMailer_addReplyToAddress'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য উত্তর ঠিকানা।';
$CIDRAM['lang']['config_PHPMailer_addReplyToName'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য উত্তর নাম।';
$CIDRAM['lang']['config_PHPMailer_setFromAddress'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য প্রেরক ঠিকানা।';
$CIDRAM['lang']['config_PHPMailer_setFromName'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য প্রেরক নাম।';
...
$CIDRAM['lang']['config_general_empty_fields'] = 'ব্লক ইভেন্ট তথ্য লগিং এবং প্রদর্শন করা হলে, CIDRAM কীভাবে ফাঁকা ক্ষেত্রগুলি পরিচালনা করবে? "include" = খালি ক্ষেত্রগুলি অন্তর্ভুক্ত করুন। "omit" = খালি ক্ষেত্রগুলি লুকান করুন [ডিফল্ট]।';
...
$CIDRAM['lang']['config_rate_limiting_precision_ipv4'] = 'IPv4 ব্যবহার ট্র্যাকিং জন্য ব্যবহার করার নির্ভুলতা। মান আয়না CIDR ব্লক আকার। সেরা স্পষ্টতা জন্য 32 সেট করুন। ডিফল্ট = "32"।';
$CIDRAM['lang']['config_rate_limiting_precision_ipv6'] = 'IPv6 ব্যবহার ট্র্যাকিং জন্য ব্যবহার করার নির্ভুলতা। মান আয়না CIDR ব্লক আকার। সেরা স্পষ্টতা জন্য 128 সেট করুন। ডিফল্ট = "128"।';
...
$CIDRAM['lang']['field_delete'] = 'মুছে ফেলা';
...
$CIDRAM['lang']['field_include'] = 'খালি ক্ষেত্রগুলি অন্তর্ভুক্ত করুন';
...
$CIDRAM['lang']['field_omit'] = 'খালি ক্ষেত্রগুলি লুকান করুন';
...
$CIDRAM['lang']['field_reasonmessage'] = 'কেন অবরুদ্ধ (বিশদ)';
...
$CIDRAM['lang']['field_ualc'] = 'User Agent (ছোট হাতের)';
...
$CIDRAM['lang']['label_aux_logic_any'] = 'যেকোন "সমান" (=) শর্তগুলি নিয়মটিকে ট্রিগার করতে পারে, যতক্ষণ "সমান নয়" (≠) শর্তগুলিও পূরণ হয়।';
$CIDRAM['lang']['label_aux_menu_action'] = 'নিম্নলিখিত শর্ত পূরণ করা হলে, অনুরোধ %s।';
$CIDRAM['lang']['label_aux_menu_method'] = 'শর্ত পরীক্ষা করার জন্য %s ব্যবহার করুন।';
$CIDRAM['lang']['label_aux_mtdReg'] = 'নিয়মিত অভিব্যক্তি';
$CIDRAM['lang']['label_aux_mtdStr'] = 'সরাসরি স্ট্রিং তুলনা';
$CIDRAM['lang']['label_aux_mtdWin'] = 'উইন্ডোজ শৈলী ওয়াইল্ডকার্ড';
$CIDRAM['lang']['label_aux_name'] = 'নতুন নিয়ম জন্য একটি নাম:';
$CIDRAM['lang']['label_aux_reason'] = 'অবরুদ্ধ যখন ব্যবহারকারীকে দেওয়া কারণ:';
...
$CIDRAM['lang']['label_check_aux'] = 'এছাড়াও অক্জিলিয়ারী নিয়ম বিরুদ্ধে পরীক্ষা করুন।';
...
$CIDRAM['lang']['label_fmgr_free_space'] = 'উপলব্ধ ডিস্ক স্থান: ';
$CIDRAM['lang']['label_fmgr_other_sig'] = 'অন্যান্য নিয়ম, স্বাক্ষর ফাইল, ইত্যাদি';
$CIDRAM['lang']['label_fmgr_safety'] = 'নিরাপত্তা প্রক্রিয়া';
...
$CIDRAM['lang']['label_unignore'] = 'এই উপেক্ষা করুন না';
...
$CIDRAM['lang']['link_aux'] = 'অক্সিলিয়ারি নিয়ম';
...
$CIDRAM['lang']['response_aux_none'] = 'বর্তমানে কোন অক্সিলিয়ারি নিয়ম নেই।';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = 'নতুন অক্সিলিয়ারি নিয়ম, "%s", সফলভাবে তৈরি।';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = 'অক্সিলিয়ারি নিয়ম, "%s", সফলভাবে মুছে ফেলা হয়েছে।';
...
$CIDRAM['lang']['security_warning'] = 'আপনার অনুরোধ প্রক্রিয়াকরণের সময় একটি অপ্রত্যাশিত সমস্যা ঘটেছে। অনুগ্রহপূর্বক আবার চেষ্টা করুন। সমস্যা থাকলেও, সমর্থন যোগাযোগ করুন।';
...
$CIDRAM['lang']['state_sl_totals'] = 'মোট (স্বাক্ষর: <span class="txtRd">%s</span> – স্বাক্ষর বিভাগ: <span class="txtRd">%s</span> – স্বাক্ষর ফাইল: <span class="txtRd">%s</span> – Unique section tags: <span class="txtRd">%s</span>)।';
...
$CIDRAM['lang']['tip_aux'] = 'হ্যালো, {username}।<br />আপনি CIDRAM জন্য অক্সিলিয়ারি নিয়ম তৈরি, মুছতে এবং সংশোধন করতে এই পৃষ্ঠাটি ব্যবহার করতে পারেন।';
...
$CIDRAM['lang']['tip_condition_placeholder'] = 'একটি মান উল্লেখ করুন, অথবা উপেক্ষা করতে ফাঁকা ছেড়ে।';
...
$CIDRAM['lang']['tip_ip_test_switches'] = '(নির্বাচিত না হলে শুধুমাত্র স্বাক্ষর ফাইলগুলি পরীক্ষা করা হবে)।';
...
$CIDRAM['lang']['tip_pie_html'] = 'আরো বিস্তারিত জানার জন্য কম্পোনেন্ট নাম ক্লিক করুন।';
...
$CIDRAM['lang']['info_some_useful_links'] = 'কিছু দরকারী লিঙ্ক:<ul>
      ...
      <li><a href="https://bgp.he.net/">Hurricane Electric BGP টুলকিট</a> – ASNগুলি থেকে CIDRগুলি পান, ASN সম্পর্কগুলি নির্ধারণ করুন, নেটওয়ার্ক নাম উপর ভিত্তি করে ASNগুলি আবিষ্কার, ইত্যাদি।</li>
