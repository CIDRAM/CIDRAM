 ...
 * @see LICENSE.txt
 *
 * This file: Bangla language data for the front-end (last modified: 2017.09.24).
 */
...
$CIDRAM['lang']['response_component_update_error'] = 'কম্পোনেন্ট আপডেট করার চেষ্টা করার সময় একটি ত্রুটি ঘটেছে।';
