 ...
 * @see LICENSE.txt
 *
 * This file: Thai language data for the front-end (last modified: 2018.08.13).
 */
...
$CIDRAM['lang']['config_PHPMailer'] = 'คำสั่งกำหนดค่าเหล่านี้อาจจำเป็นสำหรับฟังก์ชันที่เกี่ยวข้องกับการส่งอีเมล. โปรดดูเอกสารประกอบเพื่อดูข้อมูลเพิ่มเติมและค่าแนะนำ.';
