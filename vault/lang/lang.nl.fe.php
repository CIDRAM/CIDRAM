...
$CIDRAM['lang']['Extended Description: Chart.js'] = 'Hiermee kan de frontend taartdiagrammen genereren.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> is beschikbaar via de <a href="https://opensource.org/licenses/MIT">MIT license</a>.';
$CIDRAM['lang']['Extended Description: PHPMailer'] = 'Vereist voor het gebruik van functionaliteit die het verzenden van e-mail vereisen.<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a> is beschikbaar via de <a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a>-licentie.';
...
$CIDRAM['lang']['Extended Description: module_botua.php'] = 'Blokkeert gebruikersagenten die zijn gekoppeld aan ongewenste bots en schadelijke activiteiten.';
...
$CIDRAM['lang']['Name: compat_bunnycdn.php'] = 'BunnyCDN compatibiliteitsmodule';
...
$CIDRAM['lang']['Name: module_botua.php'] = 'Optionele gebruikersagent module';
...
$CIDRAM['lang']['Name: module_ua.php'] = 'Lege UA blocker module';
...
$CIDRAM['lang']['config_rate_limiting_precision_ipv4'] = 'De precisie om te gebruiken bij het monitoren op het gebruik van IPv4. Waarde weerspiegelt de CIDR-blokgrootte. Stel in op 32 voor de beste precisie. Standaard = 32.';
$CIDRAM['lang']['config_rate_limiting_precision_ipv6'] = 'De precisie om te gebruiken bij het monitoren op het gebruik van IPv6. Waarde weerspiegelt de CIDR-blokgrootte. Stel in op 128 voor de beste precisie. Standaard = 128.';
...
$CIDRAM['lang']['config_signatures_ipv4'] = 'Een lijst van de IPv4 signatuurbestanden dat CIDRAM moet proberen om te gebruiken, afgebakend door komma\'s.';
$CIDRAM['lang']['config_signatures_ipv6'] = 'Een lijst van de IPv6 signatuurbestanden dat CIDRAM moet proberen om te gebruiken, afgebakend door komma\'s.';
...
$CIDRAM['lang']['field_Request_Method'] = 'Verzoek methode';
$CIDRAM['lang']['field_activate'] = 'Activeren';
$CIDRAM['lang']['field_add_more_conditions'] = 'Voeg meer voorwaarden';
...
$CIDRAM['lang']['field_delete'] = 'Verwijder';
...
$CIDRAM['lang']['field_reasonmessage'] = 'Waarom Geblokkeerd (gedetailleerd)';
...
$CIDRAM['lang']['field_ualc'] = 'User Agent (kleine letters)';
...
$CIDRAM['lang']['label_aux_logic_any'] = 'Elke "gelijk" (=) voorwaarde kan de regel activeren, zolang aan alle "niet gelijk" (≠) voorwaarden ook wordt voldaan.';
$CIDRAM['lang']['label_aux_menu_action'] = 'Als de volgende voorwaarden zijn vervuld, %s het verzoek.';
$CIDRAM['lang']['label_aux_menu_method'] = 'Gebruik %s om de voorwaarden te testen.';
$CIDRAM['lang']['label_aux_mtdReg'] = 'reguliere expressies';
$CIDRAM['lang']['label_aux_mtdStr'] = 'directe stringvergelijking';
$CIDRAM['lang']['label_aux_mtdWin'] = 'wildcards in Windows-stijl';
$CIDRAM['lang']['label_aux_name'] = 'Een naam voor de nieuwe regel:';
$CIDRAM['lang']['label_aux_reason'] = 'De reden die de gebruiker wordt gegeven wanneer geblokkeerd:';
...
$CIDRAM['lang']['label_check_aux'] = 'Test ook tegen hulpregels.';
...
$CIDRAM['lang']['label_other-ActiveIPv4'] = 'Actieve IPv4 signatuurbestanden';
$CIDRAM['lang']['label_other-ActiveIPv6'] = 'Actieve IPv6 signatuurbestanden';
...
$CIDRAM['lang']['label_unignore'] = 'Niet negeer dit';
...
$CIDRAM['lang']['link_aux'] = 'Aanvullende Regels';
...
$CIDRAM['lang']['response_aux_none'] = 'Er zijn momenteel geen aanvullende regels.';
$CIDRAM['lang']['response_aux_rule_created_successfully'] = 'Nieuwe aanvullende regel, "%s", succesvol aangemaakt.';
$CIDRAM['lang']['response_aux_rule_deleted_successfully'] = 'Aanvullende regel, "%s", succesvol verwijderd.';
...
$CIDRAM['lang']['state_sl_totals'] = 'Totalen (Signatures: <span class="txtRd">%s</span> – Signature secties: <span class="txtRd">%s</span> – Signatuurbestanden: <span class="txtRd">%s</span> – Unieke sectie etiketten: <span class="txtRd">%s</span>).';
...
$CIDRAM['lang']['tip_aux'] = 'Hallo, {username}.<br />U kunt deze pagina gebruiken om aanvullende regels voor CIDRAM te maken, te verwijderen en aan te passen.';
...
$CIDRAM['lang']['tip_condition_placeholder'] = 'Geef een waarde op of laat blanco om te negeren.';
...
$CIDRAM['lang']['tip_ip_test_switches'] = '(Wanneer niet geselecteerd, worden alleen de signatuurbestanden getest tegen).';
...
$CIDRAM['lang']['title_login'] = 'Inloggen';
...
$CIDRAM['lang']['warning_signatures_1'] = 'Geen signatuurbestanden zijn actief!';
...
$CIDRAM['lang']['info_some_useful_links'] = 'Enkele nuttige links:<ul>
      ...
      <li><a href="https://bgp.he.net/">Hurricane Electric BGP Toolkit</a> – Krijg CIDR\'s van ASN, bepalen ASN relaties, ontdek ASN\'s op basis van netwerknamen, ezv.</li>
