 ...
 * @see LICENSE.txt
 *
 * This file: Vietnamese language data (last modified: 2016.08.06).
 */
...
$CIDRAM['lang']['ReasonMessage_BadIP'] = 'Truy cập của bạn để trang này bị từ chối bởi vì bạn đã cố gắng truy cập trang này sử dụng một địa chỉ IP không hợp lệ.';
