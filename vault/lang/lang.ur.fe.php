...
$CIDRAM['lang']['config_general_disable_webfonts'] = 'ویب فونٹس کے غیر فعال کریں؟ True (سچے) = جی ہاں [پہلے سے طے شدہ]؛ False (جھوٹی) = کوئی.';
...
$CIDRAM['lang']['config_general_empty_fields'] = 'جب بلاک ایونٹ کی معلومات لاگ ان اور ڈسپلے کرنا، CIDRAM کو خالی شعبوں کو کیسے ہینڈل کرنا چاہئے؟ "include" = خالی شعبیں شامل کریں. "omit" = خالی خالی جگہیں چھپائیں [پہلے سے طے شدہ].';
...
$CIDRAM['lang']['config_general_social_media_verification'] = 'سوشل میڈیا کی درخواستوں کی توثیق کرنے کی کوشش؟ سوشل میڈیا کی توثیق جعلی سوشل میڈیا کی درخواستوں کے خلاف تحفظ فراہم کرتا ہے (ایسی درخواستوں کو بلاک کردیا جائے گا). True (سچے) = سماجی میڈیا کی توثیق کو فعال کریں [پہلے سے طے شدہ]؛ False (جھوٹی) = سوشل میڈیا کی توثیق کو غیر فعال کریں.';
...
$CIDRAM['lang']['field_delete'] = 'حذف کریں';
...
$CIDRAM['lang']['field_include'] = 'خالی شعبیں شامل کریں';
...
$CIDRAM['lang']['field_omit'] = 'خالی خالی جگہیں چھپائیں';
...
$CIDRAM['lang']['label_aux_logic_any'] = 'کسی بھی "=" شرائط حکمران کو متحرک کرسکتے ہیں، جب تک کہ تمام "≠" شرائط پوری ہوجائے.';
...
$CIDRAM['lang']['label_unignore'] = 'اسے نظر انداز نہ کرو';
...
$CIDRAM['lang']['switch-tracking-aux-set-false'] = 'اضافی قواعد کے خلاف چیک نہ کریں';
$CIDRAM['lang']['switch-tracking-aux-set-true'] = 'اضافی قواعد کے خلاف چیک کریں';
